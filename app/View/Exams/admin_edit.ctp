					...
					<div class="row">
                        <div class="col-md-9">
                                ...
                                <div class="col-md-3">
                                    ...
                                    echo $this->Form->input($nameprefix.'[EX_DATE]', array('type' => 'text', 'default' => '', 'class' => 'form-control date-picker', 'label' => FALSE_VALUE,'div' => FALSE_VALUE,"value"=>$exam["ExamXref"]["EX_DATE"]));
