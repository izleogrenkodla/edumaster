        ...
        <div class="portlet-body form">
                                ...
                                <div class="col-md-9 tooltips"  data-container="body" data-placement='bottom'
                                     ...
                                     <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[StudentRegistration][GENDER]" value="Male" <?php echo $this->request->data['StudentRegistration']['GENDER'] == 'Male' ? "checked" : ""; ?>/>
                                            Male </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[StudentRegistration][GENDER]" value="Female" <?php echo $this->request->data['StudentRegistration']['GENDER'] == 'Female' ? "checked" : ""; ?>/>
                                            Female </label>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom' data-html='true' data-original-title="Middle Name">
                                    <?php echo $this->Form->input('FATHER_EMAIL', array('type' => 'text',
                                        'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control', 'placeholder' => 'Example :- ( demo@gmail.com )')); ?>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Contact No<span class="required">
										* </span></label>
                               <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Mobile No.">
                                    <?php echo $this->Form->input('CONTACT_NO', array('type' => 'text',
                                        'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control', 'placeholder' => 'Example :- ( 0261-5566778 )')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[StudentRegistration][STATUS]" value="1" <?php echo $this->request->data['StudentRegistration']['STATUS'] == 1 ? "checked" : ""; ?> />
                                            Active </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[StudentRegistration][STATUS]" value="0" <?php echo $this->request->data['StudentRegistration']['STATUS'] == 0 ? "checked" : ""; ?> />
                                            Inactive </label>
                                    </div>
                                </div>
                            </div>
...
function selectuid(data){
            ...
            var vid = $(data).val();
            var data = 'id='+ vid+ '&uid='+<?php echo $this->request->data['StudentRegistration']['FORM_NO']?>;
            //alert(data);
            $.ajax({
            data:data,
            url:REQUEST_URL+"StudentRegistration/edt_chkuid",
            type:"POST",
            cache:false,
...
function selectaddh(data){
            ...
            $.ajax({
            data:data,
            url:REQUEST_URL+"StudentRegistration/edt_addh",
            type:"POST",
            cache:false,
                // multiple data sent using ajax
            success: function (html) {
