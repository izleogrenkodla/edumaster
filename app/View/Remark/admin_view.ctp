...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp; View Remark
            </div>
            <div class="tools">
                    ...
                    <div class="row">
					  ...
					  <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips">
                                  <?php echo $list['Remark']['DESCRIPTION']  ?>
                                </div>
                            </div>
                        </div>
						...
						<div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Remark From</label>
                                <div class="col-md-9 tooltips">
