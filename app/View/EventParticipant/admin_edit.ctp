    ...
    <div class="portlet box blue-madison">
        ...
        <div class="portlet-body form">
            ...
            <?php echo $this->Form->create('EventParticipant', array('class' => 'form-horizontal add', 'id' => 'Roles')); ?>
			 <?php echo $this->Form->input("PARTICIPANT_ID", array('type' => 'hidden', 'label' => false, 'div' => false)) ?>
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-6">
...
<script>
	function fn_showStudents(data){
			...
			type:"POST",
			cache:false,
			url:REQUEST_URL+"EventParticipant/studentname",    // multiple data sent using ajax
