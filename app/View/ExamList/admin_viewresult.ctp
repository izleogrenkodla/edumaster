				...
				<tr>
					...
					<td class="ul_action">
						...
						foreach($Examtypelist as $key=>$list) { 
							...
							<a href="<?php echo Router::url(array('controller' => 'ExamList','action' => 'showresult', $list['ExamList']['EXAM_TYPE_ID'],$user['User']['ID'],
							))?>" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="View Result">
