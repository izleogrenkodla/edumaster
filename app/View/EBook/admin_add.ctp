        ...
        <ul class="page-breadcrumb breadcrumb">
            <li class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    ...
                    <li>
                        <a href="<?php echo Router::url(array('controller' => 'EBook', 'action' => 'add')) ?>">Add New EBook</a>
                    </li>
                </ul>
            </li>
            <li>
...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp; Add EBook
            </div>
            <div class="tools">
...
<?php }else{ 
                            echo $this->Form->input('CLASS_ID', array('type' =>'hidden','value'=> $authUser["CLASS_ID"]));
