...
<div class="portlet-body">
   ...
   <?php if(in_array($authUser["ROLE_ID"],array(TEACHER_ID)) || $authUser["ROLE_ID"]==ADMIN_ID || $authUser["ROLE_ID"]==SUPERVISOR_ID) { //ADMIN_ID, ?>
...
<?php } ?>
    ...
    <?php if($authUser["ROLE_ID"]==TEACHER_ID || $authUser["ROLE_ID"]==ADMIN_ID || $authUser["ROLE_ID"]==SUPERVISOR_ID) { ?>
    <th>
        Action
    </th>
    <?php } ?>
