...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp;Add Vehicle
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('Vehicle', array('class' => 'form-horizontal add', 'id' => 'Vehicle')); ?>
                <div class="form-body">
                    <div class="row">
         <div class="col-md-6">
                                ...
                                <div class="col-md-9 tooltips">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[Vehicle][STATUS]" value="1" checked/>
                                            Active </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[Vehicle][STATUS]" value="0" />
                                            Inactive </label>
                                    </div>
                                </div>
                            </div>
