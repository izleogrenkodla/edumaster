...
<?php if(count($data) > 0):
    ...
    <?php foreach($data as $act_grp) { ?>
        <tr>
			...
			?>			
			<td class="text-center"><?php echo $act_grp['AccountLedgerDetail']['DATE']; ?></td>
			...
			<td class="text-center"><?php echo $act_grp['AccountLedgerDetail']['SORT_ORDER']; ?></td>
			...
			<?php if($authUser["ROLE_ID"]==ACCOUNT_ID) { ?>	
                <a href="<?php echo Router::url(array('controller' => 'AccountLedgerDetails',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'AccountLedgerDetails','action' => 'delete', $act_grp['AccountLedgerDetail']['ACCOUNT_LEDGER_DET_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
