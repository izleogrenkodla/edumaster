...
<!--<strong> Search Form:</strong>-->
				...
				<div class="form-body">
                       ...
                       <?php echo $this->Form->create('SmsComm', array('class' => 'form-horizontal add','type' => 'file', 'onload' => 'loading()')); ?>
						...
						<?php echo $this->Form->create('SmsComm', array('class' => 'form-horizontal add', 'onsubmit'=>'check_valid','type' => 'file','url' => array('controller' => 'SmsComm', 'action' => 'list'))); ?>
			...
			<?php if(count($users) > 0): ?>
				<?php foreach($users as $key=>$user) { ?>
					<tr> 
						...
						<td class="text-center"><input  id="check"  class="mail_checkbox" type="checkbox" name="selected_users[]" value =<?php echo $user['User']['ID']; ?> ></td>
