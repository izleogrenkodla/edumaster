...
<div class="portlet-title">
    <div class="caption">
        <span aria-hidden="true" class="icon-users"></span>View Full & Final Settlement    </div>
</div>
    ...
    <?php foreach($list as $key=>$user) { ?>
        <tr>
			...
			<td class="text-center">    
             <a href="<?php echo Router::url(array('controller' => 'FullFinal',
                    'action' => 'add', $user['Termination']['TERM_ID'],
