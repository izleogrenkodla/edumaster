...
<?php if(in_array($authUser["ROLE_ID"],array(TRANSPORTATION_ID))){?>
    <!--<div class="table-toolbar">
		...
		<a href="<?php echo Router::url(array('controller' => 'Route','action' => 'add')) ?>" class="btn
			green bg-green"> ADD NEW <i class="fa fa-plus"></i>
		</a>
<?php } ?>	
...
<?php if(count($route) > 0):
    ...
    <?php foreach($route as $routes) { ?>
        <tr>
            ...
            <td class="text-center"><?php echo $routes['Route']['TIMING']; ?></a></td>
            
            <td class="text-center"><?php echo $routes['Route']['ROUTE_FEE']; ?></a></td>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'Route',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'Route','action' => 'delete', $routes['Route']['ROUTE_ID']))?>')" class="tooltips btn" data-placement="top" data-toggle="tooltip" title="Delete">
