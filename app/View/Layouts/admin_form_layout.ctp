...
<!--        <div class="page-logo">
        ...
        <div class="school_logo">
                <a href="<?php echo Router::url(array('controller' => 'Users', 'action' => 'dashboard', 'admin' => true, 'plugin' => false)); ?>"><img src="<?php echo DOWNLOADURL.UPLOAD_DOCUMENT.$school["School"]["LOGO_IMAGE"]; ?>" alt=""></a>
            <?php  //echo $this->Html->image('logo-small.png', array('alt' => WEBSITE_NAME, 'title' => WEBSITE_NAME, 'style' => '')); ?>
        </div>
