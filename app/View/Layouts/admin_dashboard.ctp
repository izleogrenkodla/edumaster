...
<head>
	...
	<link href="<?php echo SITE_URL; ?>css/admin/animate.css" rel="stylesheet" type="text/css"/>
...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner">
        <!-- BEGIN LOGO -->
        <?php /*?><div class="page-logo">
               <a href="<?php echo Router::url(array("controller"=>"Users","action"=>"dashboard")); ?>"><?php  echo $this->Html->image('logo-small.png', array('alt' => WEBSITE_NAME, 'title' => WEBSITE_NAME,  'style' => 'width:100%; margin-top:0;')); ?></a>
        ...
        <div class="school_logo">
        	<a href="<?php echo Router::url(array('controller' => 'Users', 'action' => 'dashboard', 'admin' => true, 'plugin' => false)); ?>"><img src="<?php echo DOWNLOADURL.UPLOAD_DOCUMENT.$profile["School"]["LOGO_IMAGE"]; ?>" alt=""></a>
        </div>
...
<!-- BEGIN CONTAINER -->
<div class="page-container dashboard_container">
    <!-- BEGIN SIDEBAR -->
