        ...
        <ul class="page-breadcrumb breadcrumb">
            <li class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li>
                        <a href="<?php echo Router::url(array('controller' => 'EventWinner', 'action' => 'index')) ?>">View All Blood Groups</a>
                    </li>
                    <li>
                        <a href="<?php echo Router::url(array('controller' => 'EventWinner', 'action' => 'add')) ?>">Add New Event Participant</a>
                    </li>
                </ul>
            </li>
            <li>
...
<script>
	function fn_showStudents(data){
			...
			type:"POST",
			cache:false,
			url:"getStudentByEvent",    // multiple data sent using ajax
