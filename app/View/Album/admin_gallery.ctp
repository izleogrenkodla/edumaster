                                                        ...
                                                        <li id="<?php echo $images['Gallery']['GALLERY_ID']; ?>" class="mupload">
                                                            ...
                                                            <div class="extras">
                                                                <div class="extras-inner">
																	...
																	<a href="<?php echo SUB_DIRECTORY . '/app/webroot/'.UPLOAD_SCHOOL_GALLERY_PHOTO
                                                                        . $images['Gallery']['IMAGE_URL']?>" class='colorbox-image' rel="group-1" data-toggle="modal" data-target="#gallery_popup_<?php echo $inc; ?>"><i class="fa fa-search"></i></a>   
                                                                    <a href="#" class='del-gallery-pic'><i class="fa fa-trash-o"></i></a>
                                                                </div>
                                                            </div>
															<!-- Modal -->
															<div class="modal fade" id="gallery_popup_<?php echo $inc; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
															  <div class="modal-dialog" role="document">
																<div class="modal-content">
																	<a href="javascript:void(0);" class="popup_close fa fa-close fa-2x" data-dismiss="modal" aria-label="Close"></a>
																  <div class="modal-body">
																	<img src="<?php echo SUB_DIRECTORY . '/app/webroot/files/'.UPLOAD_SCHOOL_GALLERY_PHOTO. $images['Gallery']['IMAGE_URL']?>" alt="" />
																  </div>
																</div>
															  </div>
															</div>
