...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>Edit Front Activity
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            <?php echo $this->Form->create('FrontActivity', array('class' => 'form-horizontal add', 'id' => 'Roles','type' => 'file')); ?>
                <?php echo $this->Form->input("Act_id", array('type' => 'hidden',  'label' => false, 'div' => false)) ?>
                <div class="form-body">
