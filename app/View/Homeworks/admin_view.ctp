						 ...
						 <div class="col-md-6">
							...
							<label class="control-label col-md-3">Photo </span></label>
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
									...
									<?php
										if(isset($lists["Homework"]["IMAGE_URL"]) && $lists["Homework"]["IMAGE_URL"]!='') {
											$img = $lists["Homework"]["IMAGE_URL"];
											$path = SITE_URL . 'files/homework_classwork/'.$img;
											?>
											<div class="preview_container">
											<a href ="<?php echo DOWNLOADURL.HOMEWORK_CLASSWORK.$lists["Homework"]["IMAGE_URL"] ?>" target = "blank" >
