        ...
        <tr>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'StoreDistribution',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'StoreDistribution','action' => 'delete', $lg['StoreDistribution']['ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
