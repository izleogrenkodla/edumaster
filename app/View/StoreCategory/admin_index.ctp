        ...
        <tr>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'StoreCategory',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'StoreCategory','action' => 'delete', $lg['StoreCategory']['ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
