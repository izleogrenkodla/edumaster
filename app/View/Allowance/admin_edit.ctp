...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp; Edit Allowance
            </div>
            <div class="tools">
                ...
                <div class="form-body">
                                 ...
                                 <div class="col-md-9 tooltips"  data-container="body" data-placement='bottom'
                                     ...
                                     <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[Allowance][ALLOWANCE_TYPE]" value="1" <?php echo $this->request->data['Allowance']['ALLOWANCE_TYPE'] == '1' ? "checked" : ""; ?>/>
                                            Addition </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[Allowance][ALLOWANCE_TYPE]" value="2" <?php echo $this->request->data['Allowance']['ALLOWANCE_TYPE'] == '2' ? "checked" : ""; ?>/>
                                            Deduction </label>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips">
                                    <?php
                                    echo $this->Form->input('ALLOWANCE_NAME', array('type' => 'text', 'default' => '', 'class' => 'form-control', 'placeholder' => 'Example :- ( TA )','label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE));
                                    ?>
                                </div>
                            </div>
                    ...
                    <div class="row">
                      ...
                      <div id = 'test'>
                       <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3"><?php echo $lb; ?><span class="required">
										* </span>
                                </label>
                                <div class="col-md-9 tooltips">
                                    <?php
                                    echo $this->Form->input($lb, array('type' => 'text', 'default' => '', 'class' => 'form-control','label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE));
                                    ?>
                                </div>
                            </div>
