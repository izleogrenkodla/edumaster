...
if(count($notices) > 0): ?>
    <?php foreach($notices as $key=>$notice) { ?>
        <tr>
            ...
            <td class="text-center"><?php echo $notice['NoticeBoard']['NOTICE_TITLE']; ?></td>
            <td class="text-center"><?php echo $notice['NoticeBoard']['NOTICE_DESC']; ?></td>
            <td class="text-center">
            
                <?php if(!in_array($authUser["ROLE_ID"],array(STUDENT_ID))) { ?>
                <a href="javascript:void(0);" class="tooltips btn" onclick="showModal('<?php echo $notice["NoticeBoard"]["NOTICE_ID"]; ?>');" data-toggle="tooltip" title="Notice Board">
