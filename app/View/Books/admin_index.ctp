        ...
        <tr>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('action' => 'edit', $book['Book']['BOOK_ID'],
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('action' => 'delete', $book['Book']['BOOK_ID']))?>')" class="tooltips btn" data-placement="top" data-toggle="tooltip" title="Delete">
