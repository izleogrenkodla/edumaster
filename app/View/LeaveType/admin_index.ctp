        ...
        <tr>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'LeaveType',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'LeaveType','action' => 'delete', $lt['LeaveType']['LEAVE_TYPE_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
