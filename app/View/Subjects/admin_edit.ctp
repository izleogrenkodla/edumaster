    ...
    <div class="portlet box blue-madison">
        ...
        <div class="portlet-body form">
            ...
            <?php echo $this->Form->create('Subject', array('class' => 'form-horizontal add', 'id' => 'Roles','type' => 'file')); ?>
			 <?php echo $this->Form->input("SUBJECT_ID", array('type' => 'hidden', 'label' => false, 'div' => false)) ?>
                <div class="form-body">
                                ...
                                <div class="col-md-9 tooltips"  data-container="body" data-placement='bottom'
                                    ...
                                    <div class="radio-list">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="data[Subject][CO_CURRICULAR]" value="0" <?php echo $this->request->data['Subject']['CO_CURRICULAR'] == 0 ? "checked" : ""; ?>/>
                                            NO </label>
											
										<label class="radio-inline">
                                            <input type="radio" name="data[Subject][CO_CURRICULAR]" value="1" <?php echo $this->request->data['Subject']['CO_CURRICULAR'] == 1 ? "checked" : ""; ?>/>
                                            YES </label>
                                    </div>
                                </div>
                            </div>
