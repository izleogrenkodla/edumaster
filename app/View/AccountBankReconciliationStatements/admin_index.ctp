...
<?php if(count($data) > 0):
    ...
    <?php foreach($data as $act_grp) { ?>
        <tr>
			...
			?>			
			<td class="text-center"><?php echo $act_grp['AccountBankReconciliationStatement']['DATE']; ?></td>
			...
			<td class="text-center"><?php echo $act_grp['AccountBankReconciliationStatement']['SORT_ORDER']; ?></td>
			...
			<?php if($authUser["ROLE_ID"]==ACCOUNT_ID) { ?>		
                <a href="<?php echo Router::url(array('controller' => 'AccountBankReconciliationStatements',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'AccountBankReconciliationStatements','action' => 'delete', $act_grp['AccountBankReconciliationStatement']['ACCOUNT_BANK_RECONCILIATION_STAT_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
