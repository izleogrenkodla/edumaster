        ...
        <ul class="page-breadcrumb breadcrumb">
            <li class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li>
                        <a href="<?php echo Router::url(array('controller' => 'StoreQuotation', 'action' => 'index')) ?>">View All Store Quotation</a>
                    </li>
                    <li>
                        <a href="<?php echo Router::url(array('controller' => 'StoreQuotation', 'action' => 'add')) ?>">Add New Store Quotation</a>
                    </li>
                </ul>
            </li>
            <li>
...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp; Edit Store Quotation
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('StoreQuotation', array('class' => 'form-horizontal add', 'id' => 'StoreQuotation')); ?>
                <div class="form-body">
                                ...
                                <div class="col-md-9 tooltips">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[StoreQuotation][STATUS]" value="1" checked/>
                                            Active </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[StoreQuotation][STATUS]" value="0" />
                                            Inactive </label>
                                    </div>
                                </div>
                            </div>
...
<script>
  function  myFunction(){
        var quantity = $("#StoreQuotationQUANTITY").val() 
        var rate = $("#StoreQuotationRATE").val() 
        var total = quantity*rate;
         $('#StoreQuotationAMOUNT').val(total);
        //alert(total);
    }
</script>