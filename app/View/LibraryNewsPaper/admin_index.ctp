        ...
        <tr>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'LibraryNewsPaper',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'LibraryNewsPaper','action' => 'delete', $category['LibraryNewsPaper']['PAPER_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
