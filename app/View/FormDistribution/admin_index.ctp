...
<?php if(count($FormDistribution) > 0): ?>
    <?php foreach($FormDistribution as $key=>$user) { ?>
        <tr>
            <td class="text-center"><?php echo $key+1; ?></td>
            <td class="text-center"><?php echo $user['FormDistribution']['FOR_DATE']; ?></td>
            <td class="text-center"><?php echo $user['Name']['STUDENT_NAME']; ?></td>
  
            <td class="text-center"><?php echo $user['AcademicClass']['CLASS_NAME']; ?></td>

            <td class="text-center"><?php echo $user['FormDistribution']['FEES']; ?></td>
