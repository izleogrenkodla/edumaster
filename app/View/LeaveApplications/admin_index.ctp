...
<td><?php echo substr($leaveApplication['LeaveApplication']['REASON'],0,50); echo strlen($leaveApplication['LeaveApplication']['REASON'])>50?"...":""; ?></td>
            ...
            <td align="center">
				<a href="<?php echo Router::url(array('controller' => 'LeaveApplications',
				 ...
				 <a href="javascript:void(0)" onclick="ch_status('<?php echo Router::url(array('controller' => 'LeaveApplications','action' => 'stactive', $leaveApplication['LeaveApplication']['LEAVE_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Approve">
				 ...
				 <?php if(in_array($leaveApplication['LeaveApplication']['LEAVE_STATUS'],array(LVSTS_PENDING,LVSTS_APPROVED))) {  ?>
				    <a href="javascript:void(0)" onclick="ch_status('<?php echo Router::url(array('controller' => 'LeaveApplications','action' => 'streject', $leaveApplication['LeaveApplication']['LEAVE_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Reject">
