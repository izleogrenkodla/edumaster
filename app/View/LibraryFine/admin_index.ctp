    ...
    <?php foreach($LibraryFine as $fine) { ?>
        <tr>
            ...
            <td class="text-center">
			   ...
			   <a href="javascript::void(0);" onclick="change_status('<?php echo Router::url(array('controller' => 'LibraryFine','action' => 'action', $fine['LibraryFine']['FINE_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Edit">
                        <i class="fa fa-check"></i></a>
				<?php } ?>
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'LibraryFine','action' => 'delete', $fine['LibraryFine']['FINE_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
