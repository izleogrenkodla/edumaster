...
<?php // echo $this->element('theme_customizer'); ?>
    ...
    <?php if($authUser["ROLE_ID"]==HR_ID) { ?>
                        <!--<div class="table-toolbar">
                            <div class="btn-group">
                                <a href="<?php echo Router::url(array('controller' => 'Users','action' => 'add_account')) ?>" class="btn
...
<?php } ?>	
						...
						<div class="sort_section">
							<div class="btn-group">
								<a class="btn btn-primary tooltips" data-toggle="tooltip" title="Export" href="<?php echo Router::url(array("action"=>"export_user",ACCOUNT_ID)); ?>">
