                    ...
                    <div class="box_content" style="display:block;">
                        <div class="row">
							...
							<?php echo $user_info["User"]["FIRST_NAME"].' &nbsp;'.$user_info["User"]["MIDDLE_NAME"].'&nbsp;'.$user_info["User"]["LAST_NAME"]; ?>
									...
									<strong>Role</strong>
                                    <address>
										<?php echo $user_info["Role"]["ROLE_NAME"]; ?>
									</address>
						...
						<?php } ?>
							...
							echo $user_info["User"]["DOB"]; ?>
								...
								<?php //if($user_info["User"]["IMAGE_URL"]!='') {
										...
										if(isset($user_info["User"]['IMAGE_URL']) && $user_info["User"]['IMAGE_URL']!="")
										{
											$user_img=$user_info["User"]['IMAGE_URL'];
...
if( (is_array($user_rep_profile) && sizeof($user_rep_profile)>1)
		...
		|| (is_array($user_rep_activity_library_dept) && sizeof($user_rep_activity_library_dept)>1)		
	  )
	{
...
?>
                    ...
                    <div class="home-boxas">
						...
						<!-- Profile -->
						<?php /* if( (is_array($user_rep_profile) && sizeof($user_rep_profile)>1) && $authUser["ROLE_ID"]==ADMIN_ID ) {
						...
						?>
                        <div class="subdashboard_box">
                            <!--<div class="subdashboard_heading">Transportation Activity</div>-->
						...
						<!-- Communication -->
						<?php /* if( (is_array($user_rep_comm) && sizeof($user_rep_comm)>1) && $authUser["ROLE_ID"]==ADMIN_ID ) {
                        ...
                        <div class="subdashboard_box">
                            ...
                            <!-- End: Transport Activity -->
							<!-- Transport Activity -->
							<?php if( (is_array($user_rep_activity_library_dept) && sizeof($user_rep_activity_library_dept)>1) ) {
								$cnt=sizeof($user_rep_activity_library_dept);
								$bck=$cnt-1;
								$inc=0;
							?>
                            <div class="subdashboard_subbox">
