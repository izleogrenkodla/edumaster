...
<div class="portlet-title">
    <div class="caption">
        <span aria-hidden="true" class="icon-users"></span>View All Admins
    </div>
</div>
<div class="portlet-body">
    ...
    <!--<div class="table-toolbar">
        <div class="btn-group">
            <a href="<?php echo Router::url(array('controller' => 'Users','action' => 'add_admin')) ?>" class="btn
					...
					<div class="action_block">
					   ...
					   <?php if($authUser["ROLE_ID"]==HR_ID) { ?>
						...
						<a href="javascript:void(0)" onclick="usr_remove('<?php echo Router::url(array('controller' => 'Users',
							'action' => 'delete_admin', $user['User']['ID'],
