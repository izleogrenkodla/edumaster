...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="#">View All Super Admins</a>
            </li>
        </ul>
...
<div class="portlet-title">
    <div class="caption">
        <span aria-hidden="true" class="icon-users"></span>View All Super Admins
    </div>
</div>
<div class="portlet-body">
    ...
    <!--<div class="table-toolbar">
        <div class="btn-group">
            <a href="<?php echo Router::url(array('controller' => 'Users','action' => 'add_super_admin')) ?>" class="btn
				...
				<div class="ul_action_inner">
					...
					<div class="action_block">				
						...
						<a href="javascript:void(0)" onclick="usr_remove('<?php echo Router::url(array('controller' => 'Users',
							'action' => 'delete_super_admin', $user['User']['ID'],
