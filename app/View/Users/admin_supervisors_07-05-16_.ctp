			...
			?>
                ...
                <?php if($authUser["ROLE_ID"]==ADMIN_ID) { ?>
                    ...
                    'action' => 'edit_supervisor', $user['User']['ID'],
                                                ...
                                                <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'Users','action' => 'delete_supervisor', $user['User']['ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
