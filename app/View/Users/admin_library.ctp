...
<?php } ?>	
						...
						<div class="sort_section">
							<div class="btn-group">
								<a class="btn btn-primary tooltips" data-toggle="tooltip" title="Export" href="<?php echo Router::url(array("action"=>"export_user",LIBRARY_ID)); ?>">
...
<?php if(count($users) > 0): ?>
    <?php foreach($users as $key=>$user) { ?>
			...
			?>
                ...
                <?php } ?>
                    ...
                    'action' => '', $user['User']['ID'],
						...
						<?php } ?>	
                                                ...
                                                <a href="<?php echo Router::url(array('controller' => 'Users',
                    'action' => 'view_library', $user['User']['ID'],
			   ...
			   ?>
                                                <a href="<?php echo Router::url(array('controller' => 'Users',
                    'action' => 'edit_library', $user['User']['ID'],
                    ...
                    'action' => 'delete_library', $user['User']['ID'],
