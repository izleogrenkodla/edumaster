...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>  Edit Admin User
            </div>
            <div class="tools">
            ...
            <?php echo $this->Form->input("ID", array('type' => 'hidden', 'label' => false, 'div' => false)) ?>
                ...
                <div class="form-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                    ...
                                    <?php echo $this->Form->input('DOB', array('type' => 'text','label' => FALSE_VALUE,
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Mobile No.">
                                    <?php echo $this->Form->input('CLASS', array('type' => 'text',
                                        'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control')); ?>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Mobile No.">
                                    <?php echo $this->Form->input('SUBJECT', array('type' => 'text',
                                        'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control')); ?>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">User Group<span class="required">
										* </span></label>
                                <div class="col-md-9">
                                    <?php
            		...
            		<div class="row">
						<div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo $this->Form->input('CITY', array('type' => 'text',
                                        'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control')); ?>
                                </div>
                            </div>
...
<?php echo $this->General->uploadfilenotes(); ?>
                            ...
                            <div style="float:right;width:500px;">
                                <img src="<?php echo DOWNLOADURL.UPLOAD_DOCUMENT.$this->request->data["User"]["IMAGE_URL"]; ?>"  width="100" />
                            </div>
