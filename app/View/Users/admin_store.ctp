...
<?php // echo $this->element('theme_customizer'); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        <div class="caption">
                            <span aria-hidden="true" class="icon-users"></span>View All Store User
                        </div>
                    </div>
	...
	?>
                        <!--<div class="table-toolbar">
                            <div class="btn-group">
                                <a href="<?php echo Router::url(array('controller' => 'Users','action' => 'add_store')) ?>" class="btn
...
<?php } ?>	
						...
						<div class="sort_section">
							<div class="btn-group">
								<a class="btn btn-primary tooltips" data-toggle="tooltip" title="Export" href="<?php echo Router::url(array("action"=>"export_user",STORE_ID)); ?>">
			...
			?>
                ...
                <?php } ?>
									...
									<!--<td class="ul_grid_view_dashboard">
                                        ...
                                        'action' => 'store_section', $user['User']['ID'],
					...
					'action' => '', $user['User']['ID'],
						...
						<?php } ?>	
                                        ...
                                        <a href="<?php echo Router::url(array('controller' => 'Users',
                    'action' => 'view_store', $user['User']['ID'],
			   ...
			   ?>
                                        <a href="<?php echo Router::url(array('controller' => 'Users',
                    'action' => 'edit_store', $user['User']['ID'],
                    ...
                    'action' => 'delete_store', $user['User']['ID'],
