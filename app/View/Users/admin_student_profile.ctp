					...
					<div class="row">
						<div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="First Name">
                                   <?php echo $user["User"]["AADHAR_NUMBER"]; ?>
                                </div>
                            </div>
                        </div>
					</div>
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                     	 <div class="col-md-6">
                                   ...
                                   <?php
                                    if(isset($user["User"]["DOCUMENT"]) && $user["User"]["DOCUMENT"]!='') {
										?>
									
									<a href="<?php echo DOWNLOADURL.UPLOAD_STUDENT_DOCUMENT.'/'.$user['User']['DOCUMENT'];?>"><?php echo $user['User']['DOCUMENT']; ?></a>
