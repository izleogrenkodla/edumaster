...
<?php // echo $this->element('theme_customizer'); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        <div class="caption">
                            <span aria-hidden="true" class="icon-users"></span>View All HR
                        </div>
                    </div>
    ...
    <?php if($authUser["ROLE_ID"]==HR_ID) { ?>
                        <!--<div class="table-toolbar">
                            <div class="btn-group">
                                <a href="<?php echo Router::url(array('controller' => 'Users','action' => 'add_hr')) ?>" class="btn
...
<?php } ?>	
						...
						<div class="sort_section">
							<div class="btn-group">
								<a class="btn btn-primary tooltips" data-toggle="tooltip" title="Export" href="<?php echo Router::url(array("action"=>"export_user",HR_ID)); ?>">
    ...
    <?php foreach($users as $key=>$user) { ?>
                ...
                <?php } ?>
									...
									<!--<td class="ul_grid_view_dashboard">
                                        ...
                                        'action' => 'hr_section', $user['User']['ID'],
