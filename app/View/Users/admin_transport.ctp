...
<?php // echo $this->element('theme_customizer'); ?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="#">Transport User</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <a href="#">View All Transport User</a>
                    </li>
                </ul>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        <div class="caption">
                            <span aria-hidden="true" class="icon-users"></span>View All Transport User
                        </div>
                    </div>
    ...
    <?php if($authUser["ROLE_ID"]==HR_ID) { ?>
                        <!--<div class="table-toolbar">
                            <div class="btn-group">
                                <a href="<?php echo Router::url(array('controller' => 'Users','action' => 'add_transport')) ?>" class="btn
...
<?php } ?>	
						...
						<div class="sort_section">
							<div class="btn-group">
								<a class="btn btn-primary tooltips" data-toggle="tooltip" title="Export" href="<?php echo Router::url(array("action"=>"export_user",TRANSPORTATION_ID)); ?>">
			...
			?>
                ...
                <?php } ?>
									...
									<!--<td class="ul_grid_view_dashboard">
                                        ...
                                        'action' => 'transport_section', $user['User']['ID'],
                    ...
                    'action' => '', $user['User']['ID'],
						...
						<?php } ?>			
                                                ...
                                                <a href="<?php echo Router::url(array('controller' => 'Users',
                    'action' => 'view_transport', $user['User']['ID'],
                ))?>" class="tooltips btn"  data-toggle="tooltip" data-placement="top" title="View">
                                                    <i class="fa fa-desktop"></i></a>

               <?php //if($authUser["ROLE_ID"]==ADMIN_ID) {
					if(in_array($authUser["ROLE_ID"],array(ADMIN_ID))) {
			   ?>
                                                <a href="<?php echo Router::url(array('controller' => 'Users',
                    'action' => 'edit_transport', $user['User']['ID'],
                    ...
                    'action' => 'delete_transport', $user['User']['ID'],
