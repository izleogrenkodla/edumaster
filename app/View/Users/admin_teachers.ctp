...
<?php // echo $this->element('theme_customizer'); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        <div class="caption">
                            <span aria-hidden="true" class="icon-users"></span>View All Teachers
                        </div>
                    </div>
                    <div class="portlet-body">
                        ...
                        <div class="row custom_search_filter">
                            ...
                            <div class="col-md-12 custom_block">
                                ...
                                <a href="<?php echo Router::url(array("action"=>"teachers")); ?>">RESET</a> OR
                                <a href="<?php echo Router::url(array("action"=>"export_teacher")); ?>"><i class="fa-file-excel-o"></i> Export</a>
                                OR
	...
	?>
                        <!--<div class="table-toolbar">
                            <div class="btn-group">
                                <a href="<?php echo Router::url(array('controller' => 'Users','action' => 'add_teacher')) ?>" class="btn
...
<?php } ?>	
						...
						<div class="sort_section">
							<div class="btn-group">
								<a class="btn btn-primary tooltips" data-toggle="tooltip" title="Export" href="<?php echo Router::url(array("action"=>"export_teacher")); ?>">
			...
			?>
                ...
                <?php } ?>
									...
									<!--<td class="ul_grid_view_dashboard">
                                        ...
                                        'action' => 'teacher_section', $user['User']['ID'],
                    ...
                    'action' => '', $user['User']['ID'],
												...
												<?php if($authUser["ROLE_ID"]==ADMIN_ID || $authUser["ROLE_ID"]==HR_ID || $authUser["ROLE_ID"]==SUPERVISOR_ID ) { ?>
						...
						<?php } ?>	
                                                ...
                                                <a href="<?php echo Router::url(array('controller' => 'Users',
                    'action' => 'view_teacher', $user['User']['ID'],
			   ...
			   ?>
                                                <a href="<?php echo Router::url(array('controller' => 'Users',
                    'action' => 'edit_teacher', $user['User']['ID'],
                ))?>" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Edit">
                                                    <i class="fa fa-pencil"></i></a>

                                                <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'Users','action' => 'delete_teacher', $user['User']['ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
