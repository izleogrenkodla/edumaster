...
?>
                    ...
                    <div class="home-boxas">
						...
						<!-- Profile -->
						<?php if( (is_array($user_rep_profile) && sizeof($user_rep_profile)>1) && ($authUser["ROLE_ID"]==ADMIN_ID || $authUser["ROLE_ID"]==SUPERVISOR_ID) ) {
						...
						?>
                        <div class="subdashboard_box">
                            <div class="subdashboard_heading">Teacher Activity</div>
						...
						<!-- Communication -->
						<?php if( (is_array($user_rep_comm) && sizeof($user_rep_comm)>1) && ($authUser["ROLE_ID"]==ADMIN_ID || $authUser["ROLE_ID"]==SUPERVISOR_ID) ) {
