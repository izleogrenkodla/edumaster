...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>  Edit Teacher
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            'type' => 'file')); ?>
                <div class="form-body">
                    <h3 class="form-section">Teacher Info</h3>
                    ...
                    <div class="row">
                        ...
                        <!--<div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Upload Profile Photo">
                                    <?php //echo $this->Form->input('UPLOAD_ADDRESS', array('type' => 'file', 'label' => FALSE_VALUE,'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control')); ?>
									<?php //echo $this->General->uploadfilenotes(); ?>
									<?php /*
