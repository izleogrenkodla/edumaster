					...
					<div class="circular_timeline">
						...
						<div class="ct_box unread">
							<div class="ct_datebox">
								...
								?></span>
								<div class="ct_dateinner">
									<span class="ct_date"><?php echo date('d', strtotime($date));?></span>
									<span class="ct_month"><?php echo date('M', strtotime($date));?></span>
					...
					<div class="scroll_container">
					 <?php foreach($studentleavedata as $stuleave):?>
						...
						<div class="leave_list">
							...
							<h6>Class: <?php echo $stuleave['AcademicClass']['CLASS_NAME'];?></h6>
							<div class="leave_duration">
								<span class="date_from">
...
<?php if($authUser["ROLE_ID"]==TEACHER_ID || $authUser["ROLE_ID"]==STUDENT_ID) { ?>
        <!-- box_block -->
...
if( (is_array($dep) && sizeof($dep)>0)) { //  && $authUser["ROLE_ID"]!=TRANSPORTATION_ID && $authUser["ROLE_ID"]!=LIBRARY_ID  ?>
                <div class="home-boxas">
...
if( (is_array($me) && sizeof($me)>0) && $authUser["ROLE_ID"]!=TRANSPORTATION_ID && $authUser["ROLE_ID"]!=LIBRARY_ID ) {  ?>
                <div class="home-boxas">
...
if( (is_array($gen) && sizeof($gen)>0) && ($authUser["ROLE_ID"]==ADMIN_ID) ) {   ?>
