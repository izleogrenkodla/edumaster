...
<?php if(count($data) > 0):
    ...
    <?php foreach($data as $act_grp) { ?>
        <tr>
			...
			<td class="text-center"><?php echo $act_grp['AccountDepartment']['SORT_ORDER']; ?></td>
            ...
            <td class="text-center">			
                <a href="<?php echo Router::url(array('controller' => 'AccountDepartments',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'AccountDepartments','action' => 'delete', $act_grp['AccountDepartment']['ACCOUNT_DEPARTMENT_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
