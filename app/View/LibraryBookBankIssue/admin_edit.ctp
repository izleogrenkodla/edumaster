...
<?php echo $this->Form->input('CLASS_ID', array('options' => $class,
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips">
								<div id="students">
<?php echo $this->Form->input('USER_ID', array('options' => $user,
                                       'default' => 'Select', 'label' => FALSE_VALUE, 'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control select2me' ,'id'=>'role')); ?>	
...
function fn_getStudent(data){
		var cid = $(data).val();
			...
			$.ajax({
			data:data,
			url:REQUEST_URL+"LibraryBookBankIssue/getStudent",
			type:"POST",
			cache:false,
	...
	function fn_getBookbank(data){
			...
			$.ajax({
			data:data,
			url:REQUEST_URL+"LibraryBookBankIssue/getBooks",
			type:"POST",
			cache:false,
			success: function (html) {
