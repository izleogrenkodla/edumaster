    ...
    <?php foreach($LibraryBookBankIssue as $lib) { ?>
        <tr>
			...
			<?php if($lib['LibraryBookBankIssue']['Status'] == "Pending"){  ?>
                ...
                <a href="javascript::void(0);" onclick="return_book('<?php echo Router::url(array('controller' => 'LibraryBookBankIssue','action' => 'Return', $lib['LibraryBookBankIssue']['BOOK_BANK_ISSUE_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Return">
			...
			<?php }else{
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'LibraryBookBankIssue','action' => 'delete', $lib['LibraryBookBankIssue']['BOOK_BANK_ISSUE_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
