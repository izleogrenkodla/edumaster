...
<?php if(in_array($authUser["ROLE_ID"],array(TRANSPORTATION_ID))){?>
	...
	<a href="<?php echo Router::url(array('controller' => 'VehicleShift','action' => 'add')) ?>" class="btn
        green bg-green"> ADD NEW <i class="fa fa-plus"></i>
	</a>
<?php }?>
...
<?php if(count($data) > 0):
    ...
    <?php foreach($data as $vehicle) { ?>
        <tr>
            ...
            <td class="text-center"><?php echo $vehicle['VehicleShift']['VEHICLE_SHIFT_TYPE']; ?></a></td>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'VehicleShift',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'VehicleShift','action' => 'delete', $vehicle['VehicleShift']['SHIFT_ID']))?>')" class="tooltips btn" data-placement="top" data-toggle="tooltip" title="Delete">
