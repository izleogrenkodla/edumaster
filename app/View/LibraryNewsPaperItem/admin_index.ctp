        ...
        <tr>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'LibraryNewsPaperItem',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'LibraryNewsPaperItem','action' => 'delete', $NewsItem['LibraryNewsPaperItem']['NEWS_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
