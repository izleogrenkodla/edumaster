							    ...
							    <div class="col-md-9 tooltips">
                                   <div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
														<a href ="<?php echo $this->request->data["Result"]["RESULT_UPLOAD"]; ?>" target = "blank" >
														<img src="<?php echo $this->request->data["Result"]["RESULT_UPLOAD"]; ?>" width="100%" />
														</a>
												</div>
									</div>
									<div class="clearfix margin-top-10">
										<span class="label label-danger">NOTE! </span>
										<strong>&nbsp; if you choose upload result instead of enter marks  then it will consider only uploaded result will display only uploaded result, Also Image preview only works in IE10+, FF3.6+, Safari6.0+, Chrome6.0+ and Opera11.1+. In older browsers the filename is shown instead.  </strong>
									</div>
									<strong>
