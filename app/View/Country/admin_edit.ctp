                ...
                <ul class="page-breadcrumb breadcrumb">
					<li class="btn-group">
						...
						<ul class="dropdown-menu pull-right">
							<li>
								<a href="<?php echo Router::url(array('controller' => 'Country', 'action' => 'index')) ?>">View All Country</a>
							</li>
							<li>
								<a href="<?php echo Router::url(array('controller' => 'Country', 'action' => 'add')) ?>">Add New Country</a>
							</li>
						</ul>
					</li>
                    <li>
                                    ...
                                    <div class="form-group">
										...
										* </span>
                                        ...
                                        <div class="col-md-9 tooltips">
                                            <?php echo $this->Form->input('COUNTRY_NAME', array('type' => 'text', 'label' => FALSE_VALUE,
										...
										<div class="col-md-9">
											<div class="radio-list">
												<label class="radio-inline">
													<input type="radio" name="data[Country][STATUS]" value="1" <?php echo $this->request->data['Country']['STATUS'] == 1 ? "checked" : ""; ?> />
													Active </label>
												<label class="radio-inline">
													<input type="radio" name="data[Country][STATUS]" value="0" <?php echo $this->request->data['Country']['STATUS'] == 0 ? "checked" : ""; ?> />
													Inactive </label>
											</div>
										</div>
									</div>
