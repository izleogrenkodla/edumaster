...
<?php if(count($mediums) > 0):
    ...
    <?php foreach($mediums as $medium) { ?>
        <tr>
            ...
            <td>
			<?php if($authUser["ROLE_ID"]==ADMIN_ID) { ?>
			<a href="<?php echo Router::url(array('controller' => 'Medium', 'action' => 'edit', $medium['Medium']['MEDIUM_ID'],))?>">
			<?php } ?>
			<?php echo $medium['Medium']['MEDIUM_NAME']; ?>
			<?php if($authUser["ROLE_ID"]==ADMIN_ID) { ?>
			</a>
			<?php } ?>
			</td>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'Medium',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'Medium','action' => 'delete', $medium['Medium']['MEDIUM_ID']))?>')" class="tooltips btn" data-placement="top" data-toggle="tooltip" title="Delete">
