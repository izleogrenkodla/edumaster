        ...
        <tr>
            ...
            <td class="text-center">
			    <a href="<?php echo Router::url(array('controller' => 'SfaffDocumentChecklist',
                    ...
                    <a href="javascript:void(0)" onclick="remove_record('<?php echo Router::url(array('controller' => 'SfaffDocumentChecklist','action' => 'delete', $SCL['SfaffDocumentChecklist']['DOC_CHE_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
