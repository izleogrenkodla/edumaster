...
<?php if(in_array($authUser["ROLE_ID"],array(TRANSPORTATION_ID))){?>
	...
	<a href="<?php echo Router::url(array('controller' => 'VehicleExpense','action' => 'add')) ?>" class="btn
        green bg-green"> ADD NEW <i class="fa fa-plus"></i>
	</a>
<?php }?>
        ...
        <tr>
			...
			<a href="<?php echo Router::url(array('controller' => 'VehicleExpense',
                ...
                <a href="<?php echo Router::url(array('controller' => 'VehicleExpense',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'VehicleExpense','action' => 'delete',  $expenses['VehicleExpense']['EXPENSE_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
