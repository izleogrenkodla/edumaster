...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>Edit Classwork
            </div>
            <div class="tools">
						 ...
						 <div class="col-md-6">
							...
							<label class="control-label col-md-3">Photo </span></label>
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
									...
									<?php
										if(isset($this->request->data["Classwork"]["IMAGE_URL"]) && $this->request->data["Classwork"]["IMAGE_URL"]!='') {
											$img = $this->request->data["Classwork"]["IMAGE_URL"];
