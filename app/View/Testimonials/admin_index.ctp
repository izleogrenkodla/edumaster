...
<?php if(count($testimonials) > 0):
    ...
    <?php foreach($testimonials as $testimonial) { ?>
        <tr>
			...
			<?php if($authUser["ROLE_ID"]==ADMIN_ID) { ?>
			<a href="<?php echo Router::url(array('controller' => 'Testimonials', 'action' => 'edit', $testimonial['Testimonial']['TESTIMONIAL_ID'],))?>">
			<?php } ?>
            ...
            <td class="text-center">
			    ...
			    <a href="<?php echo Router::url(array('controller' => 'Testimonials',
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'Testimonials','action' => 'delete', $testimonial['Testimonial']['TESTIMONIAL_ID']))?>')" class="tooltips btn" data-toggle="tooltip" data-placement="top" title="Delete">
