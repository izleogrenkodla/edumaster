$(function (e) {
    var t = {number: ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"], "short": ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], "long": ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]}, n = new Date, r = n.getFullYear(), i = n.getMonth() + 1, s = n.getDate();
    generateBirthdayPicker = function (n, s) {
        var o = e("<fieldset class='birthdayPicker'></fieldset>"), u = e("<select class='birthYear " + s.sizeClass + "' name='birth[year]'></select>"), a = e(" <select class='birthMonth " + s.sizeClass + "' name='birth[month]'></select>"), f = e(" <select class='birthDate " + s.sizeClass + "' name='birth[day]'></select>");
        $birthday = e("<input class='birthDay' name='dob' type='hidden'/>");
        if (s.placeholder) {
        ...
        o.on("change", function () {
            ...
            if (selectedYear * selectedMonth * selectedDay != 0) {
                ...
                e(this).find("input[name=dob]").val(hiddenDate)
            }
        })
    };
    ...
    e.fn.birthdayPicker.defaults = {maxAge: 100, minAge: 0, maxYear: r, dateFormat: "middleEndian", monthFormat: "number", placeholder: true, defaultDate: false, sizeClass: "span2 validate[required]"}
}(jQuery))