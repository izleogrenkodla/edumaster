...
{
	define('SITE_URL', 'http://' . SERVER_NAME .':'.$_SERVER['SERVER_PORT'].'/edusystem_bhulkasagar/app/webroot/');
}
else
{
//define('SITE_URL', 'http://' . SERVER_NAME . '/edusystem_bhulkasagar/');
define('SITE_URL', 'http://' . SERVER_NAME . '/edusystem_bhulkasagar/app/webroot/');
}
define('NOTIFY_URL', SITE_URL."paypal_ipn/process");
if(isset($_SERVER['SERVER_PORT']) && $_SERVER['SERVER_PORT']!="" && $_SERVER['SERVER_PORT']!=80)
{
define('ADMIN_URL', 'http://' . SERVER_NAME .':'.$_SERVER['SERVER_PORT'].'/edusystem_bhulkasagar/admin/');	
}
else
{
define('ADMIN_URL', 'http://' . SERVER_NAME . '/edusystem_bhulkasagar/admin/');
}
...
define('SUB_DIRECTORY', '/edusystem_bhulkasagar');
define('REQUEST_URL', '/edusystem_bhulkasagar/admin');
define('WEBSITE_URL', SITE_URL);
define('RESOURCES_DIRECTORY', '/edusystem_bhulkasagar/img/admin/');
define('FRONT_RESOURCES_DIRECTORY', '/edusystem_bhulkasagar/img/front/');
define("UPLOADURL", $_SERVER['DOCUMENT_ROOT'] . SUB_DIRECTORY . '/app/webroot/files/');
//define("ASSETS_URL", '/edusystem_bhulkasagar/assets/');
define("ASSETS_URL", '/edusystem_bhulkasagar/app/webroot/assets/');
define("AWR_CSS_URL", '/edusystem_bhulkasagar/app/webroot/');
define("FRONT_ASSETS_URL", '/edusystem_bhulkasagar/');
