...
//define('SITE_URL', 'http://' . SERVER_NAME . '/edusystem/');
define('SITE_URL', 'http://' . SERVER_NAME . '/edusystem/app/webroot/');
define('NOTIFY_URL', SITE_URL."paypal_ipn/process");
define('ADMIN_URL', 'http://' . SERVER_NAME . '/edusystem/admin/');
...
define('SUB_DIRECTORY', '/edusystem');
define('REQUEST_URL', '/edusystem/admin');
define('WEBSITE_URL', SITE_URL);
define('RESOURCES_DIRECTORY', '/edusystem/img/admin/');
define('FRONT_RESOURCES_DIRECTORY', '/edusystem/img/front/');
define("UPLOADURL", $_SERVER['DOCUMENT_ROOT'] . SUB_DIRECTORY . '/app/webroot/files/');
//define("ASSETS_URL", '/edusystem/assets/');
define("ASSETS_URL", '/edusystem/app/webroot/assets/');
define("FRONT_ASSETS_URL", '/edusystem/');
