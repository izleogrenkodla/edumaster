				 ...
				 $department = array(
					 ...
					 $com = array(
						...
						"MAILER"=>array(
							...
							"icon"=>'<i class="fa fa-cogs"></i>',
							//"url"=>Router::url(array("controller"=>"Users","action"=>"")),
							"url"=>Router::url(array("controller"=>"Mailer")),
							"bgcolor"=>"MAILER",
						),
						"SMS"=>array(
							"name"=>"3",
							"icon"=>'<i class="fa icon-pointer"></i>',
							"url"=>Router::url(array("controller"=>"SmsComm")),
							"bgcolor"=>"SMS"
						),
						"TIK_TALK"=>array(
							"name"=>"4",
						...
						"NEWS_UPDATE"=>array(
							"name"=>"14",
							"icon"=>'<i class="fa fa-cogs"></i>',
							"url"=>Router::url(array("controller"=>"News")),
							"bgcolor"=>"NEWS_UPDATE",
						),
						 "noticeboard"=>array(
							"name"=>"14",
                ...
                if(!empty($data))
                {
                    ...
                    foreach($data as $key=>$rows)
                    {
                            ...
                            if($rows[0]!='') {
                                ...
                                switch($this->request->data["User"]["ROLE_ID"]) {
                                    ...
                                    case TEACHER_ID:
                                        ...
                                        if(isset($rows[13]) && !empty($rows[13])) {
						...
						'QUALIFICATION' => $rows[11],
                                            ...
                                            'GENDER' => $rows[3],
                                            'DOB' => $this->General->excel_datefordb($rows[4]),
                                            'DOJ' => $this->General->excel_datefordb($rows[12]),
                                            'AGE' => $rows[5],
                                            'CLASS_ID' => $class_id,
                                            'MEDIUM_ID' => $medium_id,
                                            'EMAIL_ID' => $rows[9],
