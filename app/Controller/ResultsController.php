...
//	            'fields' => array('Exam.CLASS_ID'),
	...
	public function admin_getstd($Id = null)
    {
		$this->ExamList = ClassRegistry::init('ExamList');
		$this->layout = 'admin_form_layout';
		
		$conditions = array('ExamList.EXAM_TYPE_ID' => $Id);
	...
	public function admin_getStudents(){
		...
		$book = $this->Users->find('all',array(
            'conditions' => array('Users.CLASS_ID'=>$sid,'Users.ROLE_ID'=>$rid)));
