...
class ExamOralController extends AppController
{
    var $name = 'ExamOral';
    ...
    public function admin_index()
    {
        ...
        $this->paginate = array(
            ...
            'order' => 'ExamOral.CLASS_ID'
        );

        $this->set('ExamOral', $this->paginate('ExamOral'));
    }
    ...
    public function admin_add()
    {
        ...
        if ($this->request->is('post')) {
           ...
           $this->ExamOral->set($this->request->data);
				
            if ($this->ExamOral->Validation()) {
                $this->ExamOral->create();
                if ($this->ExamOral->save($this->request->data)) {
					
					$subject = $this->request->data['SUBJECT_ID'];
					$this->ExamOral->saveField("SUBJECT_ID",$subject);
		...
		$AcademicClass =  $this->ExamOral->AcademicClass->GetAcademicClasses();
		$this->set('AcademicClass',$AcademicClass);
	   
	    $examType =  $this->ExamOral->ExamType->GetExamTypes();
