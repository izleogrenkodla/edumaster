...
{ 
     ...
     public function admin_index($id = null)
    {
		...
		if((isset($id)) && ($id)>0)
			...
			if($rdata['User']['ROLE_ID'] == STUDENT_ID){
				
					$conditions['TeacherTimeTable.CLASS_ID'] = $class_id;
			}else{
				$conditions['TeacherTimeTable.TEACHER_ID'] = $id;
		...
		if(isset($this->request->data["TeacherTimeTables"]["CLASS_ID"]) && 
		($this->request->data["TeacherTimeTables"]["CLASS_ID"] > 0) &&
		isset($this->request->data["TeacherTimeTables"]["TEACHER_ID"]) && 
		($this->request->data["TeacherTimeTables"]["TEACHER_ID"] > 0) &&
		isset($this->request->data["TeacherTimeTables"]["SUBJECT_ID"]) && 
		($this->request->data["TeacherTimeTables"]["SUBJECT_ID"] > 0)  &&
		isset($this->request->data["TeacherTimeTables"]["WEEK_ID"]) && 
		($this->request->data["TeacherTimeTables"]["WEEK_ID"] > 0) ) 
		{
				
			$class =   $this->request->data["TeacherTimeTables"]["CLASS_ID"];
			$techer =   $this->request->data["TeacherTimeTables"]["TEACHER_ID"];
			$sub =   $this->request->data["TeacherTimeTables"]["SUBJECT_ID"];
			$weeks = $this->request->data["TeacherTimeTables"]["WEEK_ID"];
			
			$conditions = array('TeacherTimeTable.CLASS_ID' => $class,
			'TeacherTimeTable.TEACHER_ID' => $techer,'TeacherTimeTable.SUBJECT_ID' => $sub,'TeacherTimeTable.TT_DATE' => $weeks);
		}
		elseif(isset($this->request->data["TeacherTimeTables"]["CLASS_ID"]) && 
		($this->request->data["TeacherTimeTables"]["CLASS_ID"] > 0) &&
		isset($this->request->data["TeacherTimeTables"]["TEACHER_ID"]) && 
		($this->request->data["TeacherTimeTables"]["TEACHER_ID"] > 0) &&
		isset($this->request->data["TeacherTimeTables"]["WEEK_ID"]) && 
		($this->request->data["TeacherTimeTables"]["WEEK_ID"] > 0) ) 
		{
			...
			$conditions = array('TeacherTimeTable.CLASS_ID' => $class,'TeacherTimeTable.TEACHER_ID' => $techer,'TeacherTimeTable.TT_DATE' => $weeks);
		...
		($this->request->data["TeacherTimeTables"]["WEEK_ID"] > 0) ) 
		{
			...
			$conditions = array('TeacherTimeTable.CLASS_ID' => $class,'TeacherTimeTable.SUBJECT_ID' => $sub,'TeacherTimeTable.TT_DATE' => $weeks);
		}elseif(isset($this->request->data["TeacherTimeTables"]["TEACHER_ID"]) && 
		($this->request->data["TeacherTimeTables"]["TEACHER_ID"] > 0) &&
		isset($this->request->data["TeacherTimeTables"]["SUBJECT_ID"]) && 
		($this->request->data["TeacherTimeTables"]["SUBJECT_ID"] > 0)  &&
		isset($this->request->data["TeacherTimeTables"]["WEEK_ID"]) && 
		($this->request->data["TeacherTimeTables"]["WEEK_ID"] > 0) ) 
		{
			...
			$conditions = array('TeacherTimeTable.TEACHER_ID' => $techer,'TeacherTimeTable.SUBJECT_ID' => $sub,'TeacherTimeTable.TT_DATE' => $weeks);
		}elseif(isset($this->request->data["TeacherTimeTables"]["CLASS_ID"]) && 
		($this->request->data["TeacherTimeTables"]["CLASS_ID"] > 0) &&
		isset($this->request->data["TeacherTimeTables"]["TEACHER_ID"]) && 
		($this->request->data["TeacherTimeTables"]["TEACHER_ID"] > 0))
		...
		($this->request->data["TeacherTimeTables"]["SUBJECT_ID"] > 0))
		{
			...
			$teacher =   $this->request->data["TeacherTimeTables"]["TEACHER_ID"] ;
			$sub =   $this->request->data["TeacherTimeTables"]["SUBJECT_ID"] ;
		 ...
		 ($this->request->data["TeacherTimeTables"]["WEEK_ID"])>0) 	
		{
			...
			$conditions = array('TeacherTimeTable.TEACHER_ID' => $techer,
				'TeacherTimeTable.TT_DATE' => $weeks);
		...
		}elseif(isset($this->request->data["TeacherTimeTables"]["SUBJECT_ID"]) &&
		($this->request->data["TeacherTimeTables"]["SUBJECT_ID"] > 0) &&
		isset($this->request->data["TeacherTimeTables"]["WEEK_ID"]) &&
		 ($this->request->data["TeacherTimeTables"]["WEEK_ID"])>0) 	
		{
			...
			$weeks =$this->request->data["TeacherTimeTables"]["WEEK_ID"];
			$class =  $this->request->data["TeacherTimeTables"]["SUBJECT_ID"] ;
			$conditions = array('TeacherTimeTable.SUBJECT_ID' => $class,
				'TeacherTimeTable.TT_DATE' => $weeks);
		...
		elseif(isset($this->request->data["TeacherTimeTables"]["WEEK_ID"]) && ($this->request->data["TeacherTimeTables"]["WEEK_ID"])>0 && $Session['ID'] == ADMIN_ID && isset($id))
		{
			...
			if($rdata['User']['ROLE_ID'] == STUDENT_ID){
					...
					$conditions = array('TeacherTimeTable.TT_DATE' => $weeks,'TeacherTimeTable.CLASS_ID' => $class_id);
				
					
			
			}else{
				$weeks =$this->request->data["TeacherTimeTables"]["WEEK_ID"];
				$conditions = array('TeacherTimeTable.TT_DATE' => $weeks,'TeacherTimeTable.TEACHER_ID' => $id);
		...
		elseif(isset($this->request->data["TeacherTimeTables"]["WEEK_ID"]) && ($this->request->data["TeacherTimeTables"]["WEEK_ID"])>0 && $Session['ID'] == 1)
		{
			
			$weeks =$this->request->data["TeacherTimeTables"]["WEEK_ID"];
			$conditions = array('TeacherTimeTable.TT_DATE' => $weeks);
			
		}	
		elseif(isset($this->request->data["TeacherTimeTables"]["WEEK_ID"]) && ($this->request->data["TeacherTimeTables"]["WEEK_ID"])>0 && $Session['ID'] == ADMIN_ID)
		{
		...
		elseif(isset($this->request->data["TeacherTimeTables"]["WEEK_ID"]) && ($this->request->data["TeacherTimeTables"]["WEEK_ID"])>0 && $Session['CLASS_ID'] == 0)
		{
			
			$weeks =$this->request->data["TeacherTimeTables"]["WEEK_ID"];
			$conditions = array('TeacherTimeTable.TT_DATE' => $weeks,
				'TeacherTimeTable.TEACHER_ID' => $Session["ID"]);

			
		}
		elseif(isset($this->request->data["TeacherTimeTables"]["WEEK_ID"]) && ($this->request->data["TeacherTimeTables"]["WEEK_ID"])>0 && $Session['CLASS_ID'] > 0  && isset($id))
		{
			
			$weeks =$this->request->data["TeacherTimeTables"]["WEEK_ID"];
			$conditions = array('TeacherTimeTable.TT_DATE' => $weeks,
				'TeacherTimeTable.CLASS_ID' => $Session["CLASS_ID"],
				'TeacherTimeTable.TEACHER_ID' => $id);
				
			
		}
		elseif( (isset($this->request->data["TeacherTimeTables"]["WEEK_ID"]) && ($this->request->data["TeacherTimeTables"]["WEEK_ID"])>0 ) && ($Session['ROLE_ID'] == TEACHER_ID) )
		{	
			$weeks =$this->request->data["TeacherTimeTables"]["WEEK_ID"];
			$conditions = array('TeacherTimeTable.TT_DATE' => $weeks,
				'TeacherTimeTable.TEACHER_ID' => $Session["ID"]);
...
//            'Contain' => array('Role','AcademicClass'),
  ...
  public function App_CheckHoliday()
	...
	public function admin_GetSubjectByClass(){
		 $class = $this->request->data["id"];
		 
		 $this->subjects = ClassRegistry::init('Subject');
		 $sub = $this->subjects->find('all',array(
            'conditions' => array('Subject.CLASS_ID'=>$class)
        ));
         ...
         <div class='col-md-9'>
		<select name='SUBJECT_ID' id='SUBJECT_ID' class = 'form-control select2me'>";
		 echo "<option value='0'>Select Subject</option>";
        foreach ($sub as $s) {
			 echo "<option value='" . $s['Subject']['SUBJECT_ID'] ."'>" . $s['Subject']['TITLE'] ."</option>";
			}
