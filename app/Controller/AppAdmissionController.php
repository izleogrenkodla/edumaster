...
class AppAdmissionController extends AppController
{
    ...
    public function admin_index()
    {
		...
		if(isset($this->params->query["data"]["AppAdmission"]["CLS"]) && 
		($this->params->query["data"]["AppAdmission"]["CLS"] > 0) &&
		isset($this->params->query["data"]["AppAdmission"]["MED"]) && 
		($this->params->query["data"]["AppAdmission"]["MED"] > 0) &&
		isset($this->params->query["data"]["AppAdmission"]["STA"]))
		{
			$class =   $this->params->query["data"]["AppAdmission"]["CLS"] ;
			$med =   $this->params->query["data"]["AppAdmission"]["MED"] ;
			$sta =   $this->params->query["data"]["AppAdmission"]["STA"] ;
			
			$conditions = array('AppAdmission.CLASS_ID' => $class,
			'AppAdmission.MEDIUM_ID' => $med,'AppAdmission.INQ_STATUS' => $sta);
		}elseif(isset($this->params->query["data"]["AppAdmission"]["CLS"]) && 
		($this->params->query["data"]["AppAdmission"]["CLS"] > 0) &&
		isset($this->params->query["data"]["AppAdmission"]["MED"]) && 
		($this->params->query["data"]["AppAdmission"]["MED"] > 0))
		{
		...
		isset($this->params->query["data"]["AppAdmission"]["STA"]))
		{
			...
			$conditions = array('AppAdmission.CLASS_ID' => $class,
			'AppAdmission.INQ_STATUS' => $sta);
		}elseif(isset($this->params->query["data"]["AppAdmission"]["MED"]) && 
		($this->params->query["data"]["AppAdmission"]["MED"] > 0) &&
		isset($this->params->query["data"]["AppAdmission"]["STA"]))
		{
			$class =   $this->params->query["data"]["AppAdmission"]["MED"] ;
			$sta =   $this->params->query["data"]["AppAdmission"]["STA"] ;
			
			$conditions = array('AppAdmission.MEDIUM_ID' => $med,
			'AppAdmission.INQ_STATUS' => $sta);
		}elseif(isset($this->params->query["data"]["AppAdmission"]["CLS"]) && 
		($this->params->query["data"]["AppAdmission"]["CLASS_ID"]) > 0)
		{
			$class =   $this->params->query["data"]["AppAdmission"]["CLS"] ;
		 	$conditions = array('AppAdmission.CLASS_ID' => $class);
		...
		}elseif(isset($this->params->query["data"]["AppAdmission"]["STA"]))
		{
			$sta =   $this->params->query["data"]["AppAdmission"]["STA"] ;
			$conditions = array('AppAdmission.INQ_STATUS' => $sta);
