...
var Layout = function () {
    ...
    var layoutImgPath = JS_SITEURL + 'assets/admin/layout/img/';
    ...
    var handleSidebarMenu = function () {
        ...
        /*jQuery('.page-sidebar').ready(function(e){
         $('<div class="menu_overlay"></div>').insertAfter('.page-container');
         });
         jQuery('.page-sidebar').hover(function(e){
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            $('#style_color').attr("href", JS_SITEURL + "assets/admin/layout/css/themes/" + color_ + ".css");
            if (color == 'light2') {
                $('.page-logo img').attr('src', JS_SITEURL + 'assets/admin/layout/img/logo-invert.png');
            } else {
                $('.page-logo img').attr('src', JS_SITEURL + 'assets/admin/layout/img/logo.png');
            }
            if ($.cookie) {
...
$(document).ready(function () {
    ...
    setInterval(function () {
		...
		$(".box_12 .box_header").click(function () {
            $(".box_12 .box_content").slideToggle("slow");
        });
		$(".box_13 .box_header").click(function () {
            $(".box_13 .box_content").slideToggle("slow");
        });
		$(".box_14 .box_header").click(function () {
            $(".box_14 .box_content").slideToggle("slow");
        });
		$(".box_15 .box_header").click(function () {
            $(".box_15 .box_content").slideToggle("slow");
        });
		$(".box_16 .box_header").click(function () {
            $(".box_16 .box_content").slideToggle("slow");
        });
		...
		$("#notice_circular .scroll_container, #notice_staff_leave .scroll_container, #notice_student_leave .scroll_container, #notice_suggestion .scroll_container, #notice_news_updates .scroll_container, #notice_time_table .scroll_container, #notice_attendance .scroll_container, #notice_class_work .scroll_container, #notice_home_work .scroll_container, #notice_events .scroll_container, #notice_exam_schedual .scroll_container").slimscroll({
			height: 'auto'
		});
