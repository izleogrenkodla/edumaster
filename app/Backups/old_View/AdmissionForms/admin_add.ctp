        ...
        <ul class="page-breadcrumb breadcrumb">
            <li class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    ...
                    <li>
                        <a href="<?php echo Router::url(array('controller' => 'AdmissionForms', 'action' => 'add')) ?>">Add New Admission Form</a>
                    </li>
                </ul>
            </li>
            <li>
...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp; Add Admission Form
            </div>
            <div class="tools">
...
<?php echo $this->General->uploadfilenotesPDF(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Form Type<span class="required">
										* </span>
                                </label>
                                <div class="col-md-9 tooltips">
                                    <?php
                                    echo $this->Form->input('FORM_TYPE_ID', array('options' => $formTypes, 'default' => '', 'class' => 'form-control select2me', 'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE));
                                    ?>
                                </div>
                            </div>
                                ...
                                <div class="col-md-9 tooltips">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[AdmissionForm][STATUS]" value="1" checked/>
                                            Active </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[AdmissionForm][STATUS]" value="0" />
                                            Inactive </label>
                                    </div>
                                </div>
                            </div>
