            ...
            <td class="text-center">
			    ...
			    <a href="<?php echo Router::url(array('controller' => 'EBook',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'EBook','action' => 'delete', $ebook['EBook']['ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
