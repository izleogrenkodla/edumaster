...
<div class="portlet-title">
    <div class="caption">
        <span aria-hidden="true" class="icon-users"></span>  View All School Album
    </div>
</div>
<div class="portlet-body">
    ...
    <div class="table-toolbar">
        <div class="btn-group">
            <a href="<?php echo Router::url(array('controller' => 'Album','action' => 'add_school')) ?>" class="btn
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'Album',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="<?php echo Router::url(array('controller' => 'Album',
                    'action' => 'gallery', $album['Album']['ALBUM_ID'],'schoollist'
                ))?>" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
                   data-original-title="Edit">
