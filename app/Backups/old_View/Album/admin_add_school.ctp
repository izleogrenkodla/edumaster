...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="#">School Album</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="#">Add School Album</a>
            </li>
        </ul>
...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp; Add School Album
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            <?php echo $this->Form->input("ALBUM_TYPE", array('type' => 'hidden', 'value' =>2, 'label' => false, 'div' => false)) ?>
            <div class="form-body">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips">
                                    <?php echo $this->Form->input('ALBUM_NAME', array('type' => 'text', 'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control','placeholder' => 'Example :- ( Celebration, Festivals )')); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Album Cover Photo <span class="required">
										* </span></label>
                                ...
                                <div class="col-md-9 tooltips">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[Album][STATUS]" value="1" checked/>
                                            Active </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[Album][STATUS]" value="0" />
                                            Inactive </label>
                                    </div>
                                </div>
                            </div>
