...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        ...
        <div class="portlet-body form">
			...
			<?php echo $this->Form->input("LIB_ID", array('type' => 'hidden', 'label' => false, 'div' => false)) ?>
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-6">
					...
					<div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Select Status<span class="required">
										* </span>
                                </label>
                                <div class="col-md-9 tooltips">
                                    <?php echo $this->Form->input('STATUS', array('options' => array(array(RECEIVED_ID=>RECEIVED_BOOK,ISSUED_ID=>ISSUED_BOOK)), 'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control select2me')); ?>
                                </div>
                            </div>
                        </div>
