...
<?php if(count($achievements) > 0):
    ...
    <?php foreach($achievements as $achievement) { ?>
        <tr>
            ...
            <td class="text-center"><a href="<?php echo Router::url(array('controller' => 'Achievements', 'action' => 'edit', $achievement['Achievement']['PAGE_ID'],
                ))?>"><?php echo $achievement['Achievement']['PAGE_TITLE']; ?></a></td>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'Achievements',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'Achievements','action' => 'delete', $achievement['Achievement']['PAGE_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
