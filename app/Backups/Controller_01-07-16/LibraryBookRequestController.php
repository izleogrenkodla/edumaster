...
class LibraryBookRequestController extends AppController
{
    var $name = 'LibraryBookRequest';
    ...
    public function admin_index()
    {
        ...
        $this->paginate = array(
            ...
            'order' => 'LibraryBookRequest.created ASC'
        );

        $this->set('LibraryBookRequest', $this->paginate('LibraryBookRequest'));
    }
