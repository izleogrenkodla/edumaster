...
class FrontAboutController extends AppController
{
    var $name = 'FrontAbout';
    ...
    public function admin_add()
    {
        ...
        if ($this->request->is('post')) {
            $this->FrontAbout->set($this->request->data);
            if ($this->FrontAbout->Validation()) {
                $this->FrontAbout->create();
                if ($this->FrontAbout->save($this->request->data)) {
                    $this->Session->setFlash('Front About Added Successfully!', 'message_good');
                    $this->redirect(array('action' => 'index'));
                }
                } else {
                $this->Session->setFlash('Front About Not Added Please Try Again!', 'message_bad');
                }
        }
     ...
     public function admin_index()
    {
        ...
        $this->set('frontabout', $this->paginate('FrontAbout'));
    }
      ...
      public function admin_edit($id=null){
        ...
        if ($this->request->is('put') || $this->request->is('post')) {
            ...
            if ($this->FrontAbout->Validation()) {
				...
				{
					if ($this->request->data["FrontAbout"]["LOGO"]["size"]==0 && $this->request->data["HID_LOGO"] != "")
					{
					$exist_logo = $this->request->data["HID_LOGO"];
					$this->request->data["FrontAbout"]["LOGO"] = $exist_logo;					
					}
				}
                ...
                if ($this->FrontAbout->save($this->request->data)) {
					...
					/*$this->FrontAbout->saveField("FACEBOOK_LINK",$this->request->data["FrontAbout"]["Facebook_Link"]);
					$this->FrontAbout->saveField("YOUTUBE_LINK",$this->request->data["FrontAbout"]["Youtube_Link"]); 
					$this->FrontAbout->saveField("TWITTER_LINK",$this->request->data["FrontAbout"]["Twitter_Link"]);*/
