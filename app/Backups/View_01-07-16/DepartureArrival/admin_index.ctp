...
<?php if(count($data) > 0):
    ...
    <?php foreach($data as $deparr) { ?>
        <tr>
            ...
            <td><?php echo $deparr['VehicleShift']['VEHICLE_SHIFT_TYPE']; ?></a></td>
            <td><?php echo $deparr['Vehicle']['VEHICLE_NUMBER']; ?></a></td>
            <td><?php echo $deparr['DepartureArrival']['DEPARTURE_TIME']; ?>
            <td><?php echo $deparr['DepartureArrival']['ARRIVAL_TIME']; ?>
            <td><?php echo $deparr['DepartureArrival']['DATE']; ?>
			...
			<a href="<?php echo Router::url(array('controller' => 'DepartureArrival',
                   ...
                   data-original-title="Delete"><i class="fa fa-desktop"></i></a>
                <a href="<?php echo Router::url(array('controller' => 'DepartureArrival',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'DepartureArrival','action' => 'delete',  $deparr['DepartureArrival']['DEP_ARR_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
