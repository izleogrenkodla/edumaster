...
<?php if(count($data) > 0):
    ...
    <?php foreach($data as $act_grp) { ?>
        <tr>
			...
			<td><?php echo $act_grp['AccountName']['SORT_ORDER']; ?></td>
			...
			<?php if($authUser["ROLE_ID"]==ACCOUNT_ID) { ?>
                <a href="<?php echo Router::url(array('controller' => 'AccountNames',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'AccountNames','action' => 'delete', $act_grp['AccountName']['ACCOUNT_NAME_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
