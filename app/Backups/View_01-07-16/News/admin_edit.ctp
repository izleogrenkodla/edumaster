                                ...
                                <div class="col-md-9 tooltips">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[News][STATUS]" value="1" <?php echo $this->request->data['News']['STATUS'] == 1 ? "checked" : ""; ?>/>
                                            Active </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[News][STATUS]" value="0" <?php echo $this->request->data['News']['STATUS'] == 0 ? "checked" : ""; ?>/>
                                            Inactive </label>
                                    </div>
                                </div>
                            </div>
