...
<?php if(count($AdmissionVacancy) > 0):
    ...
    <?php foreach($AdmissionVacancy as $AV) { ?>
        <tr>
            ...
            <td class="text-center"> <a href="<?php echo Router::url(array('controller' => 'AdmissionVacancy', 'action' => 'edit', $AV['AdmissionVacancy']['ADM_VAC_ID'],
                ))?>"><?php echo $AV['AdmissionVacancy']['NUM_VACANCY']; ?></a></td>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'AdmissionVacancy',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'AdmissionVacancy','action' => 'delete', $AV['AdmissionVacancy']['ADM_VAC_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
