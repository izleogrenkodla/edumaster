...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('Appointment', array('class' => 'form-horizontal add', 'id' => 'Form',
            'type' => 'file')); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                   ...
                                   <?php echo $list['User']['FIRST_NAME'].' '. $list['User']['MIDDLE_NAME'].' ' .$list['User']['LAST_NAME']; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Last Name">
                                      <?php echo $list["User"]["BASE_SALARY"]; ?>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Last Name">
                                      <?php echo $list["User"]["JOINING_DATE"]; ?>
