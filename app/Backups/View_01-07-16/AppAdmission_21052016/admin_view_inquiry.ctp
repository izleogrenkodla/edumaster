...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>  View Inquiry
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('AppAdmission', array('class' => 'form-horizontal add', 'id' => 'Form',
            'type' => 'file')); ?>
            <?php echo $this->Form->input("INQUIRY_ID", array('type' => 'hidden', 'label' => false, 'div' => false)) ?>
                <div class="form-body">
                    <h3 class="form-section">Inquiry Information</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                    ...
                                    <?php echo $this->request->data["AppAdmission"]["STUDENT_NAME"]; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
								...
								<?php echo $this->request->data["AppAdmission"]["FATHER_NAME"]; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Last Name">
          								<?php echo $this->request->data["AppAdmission"]["MOTHER_NAME"]; ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="First Name">
                                  <?php echo $this->request->data["AppAdmission"]["AGE"]; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Password">
                                      <?php echo $this->request->data["AppAdmission"]["PHONE_NO"]; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Contact No.">
                                       <?php echo $this->request->data["AppAdmission"]["MOBILE_NO"]; ?>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Mobile No.">
                                      <?php echo $this->request->data["AppAdmission"]["EMAIL"]; ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Mobile No.">
									     <?php echo $this->request->data["AppAdmission"]["ADDRESS"]; ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Mobile No.">
                                      <?php  $status='';
										if($this->request->data['AppAdmission']['INQ_STATUS'] == 0)
            	{
            		$status = 'Pending';
            	}
            	elseif($this->request->data['AppAdmission']['INQ_STATUS'] == 1)
            	{
            		$status = 'Approved';
            	}
				elseif($this->request->data['AppAdmission']['INQ_STATUS'] == 2)
				{
					$status = 'Reject';
				}
										?>
