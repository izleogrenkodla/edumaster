...
<?php if(count($roles) > 0):
    ...
    <?php foreach($roles as $role) { ?>
        <tr>
            ...
            <td> <a href="<?php echo Router::url(array('controller' => 'Roles', 'action' => 'edit', $role['Role']['ID'],
                ))?>"><?php echo $role['Role']['ROLE_NAME']; ?></a></td>
            ...
            <td class="text-center">
                ...
                <?php if($role['Role']['ID'] != 1) { ?>
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'Roles','action' => 'delete', $role['Role']['ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
