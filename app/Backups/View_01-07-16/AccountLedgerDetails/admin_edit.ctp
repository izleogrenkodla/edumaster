...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="#">Edit Account Ledger Detail</a>
            </li>
        </ul>
...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span> Edit Account Ledger Detail
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('AccountLedgerDetail', array('class' => 'form-horizontal edit', 'id' => 'Roles','type' => 'file')); ?>
            <?php echo $this->Form->input("ACCOUNT_LEDGER_DET_ID", array('type' => 'hidden', 'label' => false, 'div' => false)) ?>
                <div class="form-body">
							...
							<div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
									...
									<?php
										...
										{
									?>
									<div class="cls_upload_doc_dl"><a href="<?php echo $ACCOUNT_LEDGER_DOCUMENT_DL; ?>" target="_blank"><?php echo $ACCOUNT_LEDGER_DOCUMENT; ?></a></div>
									<?php
										}
									?>
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[AccountLedgerDetail][STATUS]" value="1" <?php echo $this->request->data['AccountLedgerDetail']['STATUS'] == 1 ? "checked" : ""; ?> />
                                            Active </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[AccountLedgerDetail][STATUS]" value="0" <?php echo $this->request->data['AccountLedgerDetail']['STATUS'] == 0 ? "checked" : ""; ?> />
                                            Inactive </label>
                                    </div>
                                </div>
                            </div>
