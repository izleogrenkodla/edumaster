...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="#">Add New Library Member</a>
            </li>
        </ul>
...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp; Add New Library Member
            </div>
            <div class="tools">
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
								...
								<input type="hidden" name="data[LibraryMember][Status]" value="Issued"/>
                                <div class="col-md-9 tooltips">
