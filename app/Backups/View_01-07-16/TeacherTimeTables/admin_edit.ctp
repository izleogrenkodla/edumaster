...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="#">Edit Teacher Time Table</a>
            </li>
        </ul>
...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp; Edit Teacher Time Table
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
			...
			<?php echo $this->Form->input("TT_ID", array('type' => 'hidden', 'label' => false, 'div' => false)) ?>
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="col-md-9 tooltips">
                                    <?php echo $this->Form->input('START_TIME',
									 array('type' => 'text', 'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE, 'data-required' => '1',
						...
						<div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips">
                                    ...
                                    'div' => FALSE_VALUE, 'data-required' => '1',
									 'class' => 'form-control','readonly'=>'readonly',
									 //'value' => '.date(TIMEFORMAT,strtotime($this->request->data["TeacherTimeTable"]["END_TIME"])).'
									 )); ?>
                                </div>
                            </div>
                        </div>
