    ...
    <?php foreach($notices as $key=>$notice) { ?>
        <tr>
            ...
            <td class="text-center">
                ...
                <a href="javascript:void(0);" class="tooltips btn" title="View" data-toggle="tooltip" onclick="showModal('<?php echo $notice["NoticeBoard"]["NOTICE_ID"]; ?>');"  title="Sent Message" data-container="body" data-placement="top" data-html="true" data-original-title="Delete"   >
