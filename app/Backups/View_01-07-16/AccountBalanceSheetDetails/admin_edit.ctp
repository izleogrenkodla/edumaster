...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="#">Edit Account Balance Sheet Detail</a>
            </li>
        </ul>
...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span> Edit Account Balance Sheet Detail
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('AccountBalanceSheetDetail', array('class' => 'form-horizontal edit', 'id' => 'Roles')); ?>
            <?php echo $this->Form->input("ACCOUNT_BALANCE_SHEET_DET_ID", array('type' => 'hidden', 'label' => false, 'div' => false)) ?>
                <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips">
                                    <?php echo $this->Form->input('ACCOUNT_BALANCE_SHEET_HEAD_ID', array('options' => $account_balance_sheet_heads,
                                        'label' => FALSE_VALUE, 'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control select2me' , 'onchange' => 'get_bs_sub_heads()' ,'id'=>'id_acc_bs_head'));//,'onchange' => 'showOptions(this)' ?>	
                                </div>
                            </div>
                        </div>
					</div>
                                ...
                                <div class="col-md-9">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[AccountBalanceSheetDetail][STATUS]" value="1" <?php echo $this->request->data['AccountBalanceSheetDetail']['STATUS'] == 1 ? "checked" : ""; ?> />
                                            Active </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[AccountBalanceSheetDetail][STATUS]" value="0" <?php echo $this->request->data['AccountBalanceSheetDetail']['STATUS'] == 0 ? "checked" : ""; ?> />
                                            Inactive </label>
                                    </div>
                                </div>
                            </div>
