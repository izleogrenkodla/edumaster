...
<?php if(count($data) > 0):
    ...
    <?php foreach($data as $act_grp) { ?>
        <tr>
			...
			?>			
			<td><?php echo $act_grp['AccountBalanceSheetDetail']['DATE']; ?></td>
			...
			<td><?php echo $act_grp['AccountBalanceSheetDetail']['SORT_ORDER']; ?></td>
            ...
            <td class="text-center">
                ...
                ))?>" class="tooltips btn" data-container="body" data-placement="top" data-html="true" title="View Account Balance Sheet Detail"
                ...
                <a href="<?php echo Router::url(array('controller' => 'AccountBalanceSheetDetails',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'AccountBalanceSheetDetails','action' => 'delete', $act_grp['AccountBalanceSheetDetail']['ACCOUNT_BALANCE_SHEET_DET_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
