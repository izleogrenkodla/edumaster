        ...
        <tr>
            ...
            <td class="text-center">
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'StaffVacancy','action' => 'delete', $v['StaffVacancy']['VACANCY_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
