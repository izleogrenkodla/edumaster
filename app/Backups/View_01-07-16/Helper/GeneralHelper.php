...
class GeneralHelper extends AppHelper
{
   ...
   public function uploadfilenotesATTACHMENT() {
	   return "<strong>Allowed Size in mb</strong>: ".ATTACHMENT_ALLOWED_SIZE;
   }
   
   public function uploadfilenotesUPLOADDOC() {
	   return "<strong>Allowed Size in mb</strong>: ".UPLOAD_ALLOWED_SIZE;
   }
