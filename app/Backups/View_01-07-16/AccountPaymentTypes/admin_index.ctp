...
<?php if(count($data) > 0):
    ...
    <?php foreach($data as $act_grp) { ?>
        <tr>
			...
			<td><?php echo $act_grp['AccountPaymentType']['SORT_ORDER']; ?></td>
			...
			<?php if($authUser["ROLE_ID"]==ACCOUNT_ID) { ?>
                <a href="<?php echo Router::url(array('controller' => 'AccountPaymentTypes',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'AccountPaymentTypes','action' => 'delete', $act_grp['AccountPaymentType']['ACCOUNT_PAYMENT_TYPE_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
