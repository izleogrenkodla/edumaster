            ...
            <td class="text-center">
                ...
                <a href="<?php echo Router::url(array('controller' => 'Blog',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'Blog','action' => 'delete', $blog['Blog']['BLOG_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
