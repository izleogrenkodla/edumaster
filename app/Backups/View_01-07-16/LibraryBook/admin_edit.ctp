...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp; Edit  Library Book 
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
			...
			<?php echo $this->Form->input("BOOK_ID", array('type' => 'hidden', 'label' => false, 'div' => false)) ?>
                <div class="form-body">
                    <div class="row">
                    	<div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips">
                                    <?php echo $this->Form->input('BOOK_FROM', array('type' => 'text', 'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control','placeholder' => 'Example :- ( Donate, Purchase)')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-9 tooltips">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[LibraryBook][STATUS]" value="1" <?php echo $this->request->data['LibraryBook']['STATUS'] == 1 ? "checked" : ""; ?> />
                                            Active </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[LibraryBook][STATUS]" value="0" <?php echo $this->request->data['LibraryBook']['STATUS'] == 0 ? "checked" : ""; ?> />
                                            Inactive </label>
                                    </div>
                                </div>
                            </div>
