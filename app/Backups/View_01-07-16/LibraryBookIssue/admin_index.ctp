    ...
    <?php foreach($IssueBook as $i) { ?>
        <tr>
			...
			<?php if($i['LibraryBookIssue']['Status'] == "Pending"){ ?>
                <a href="javascript::void(0);" onclick="return_book('<?php echo Router::url(array('controller' => 'LibraryBookIssue','action' => 'Return', $i['LibraryBookIssue']['BOOK_ISSUE_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
			...
			<?php }else{
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'LibraryBookIssue','action' => 'delete', $i['LibraryBookIssue']['BOOK_ISSUE_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
