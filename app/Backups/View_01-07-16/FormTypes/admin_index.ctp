...
<?php if(count($types) > 0):
    ...
    <?php foreach($types as $type) { ?>
        <tr>
            ...
            <td> <a href="<?php echo Router::url(array('controller' => 'FormTypes', 'action' => 'edit', $type['FormType']['FORM_TYPE_ID'],
                ))?>"><?php echo $type['FormType']['FORM_TYPE_NAME']; ?></a></td>
            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'FormTypes',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'FormTypes','action' => 'delete', $type['FormType']['FORM_TYPE_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
