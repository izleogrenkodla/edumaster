...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="#">Edit Bank Reconciliation Statement</a>
            </li>
        </ul>
...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span> Edit Bank Reconciliation Statement
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('AccountBankReconciliationStatement', array('class' => 'form-horizontal edit', 'id' => 'Roles','type' => 'file')); ?>
            <?php echo $this->Form->input("ACCOUNT_BANK_RECONCILIATION_STAT_ID", array('type' => 'hidden', 'label' => false, 'div' => false)) ?>
                <div class="form-body">
					...
					<div class="input_fields_wrap_bnk_aha">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-md-9 tooltips">
										...
										<input type="text" placeholder="Example :- ( Deposit in Transit 1, Deposit in Transit 2 )" class="form-control" data-required="1" name="data[BANK_ADDITION_HEADS][]" value="<?php echo $BANK_ADDITION_HEADS_FV; ?>">
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-md-9 tooltips">
										...
										<input type="text" placeholder="Example :- ( 5000, 6000 )" class="form-control" data-required="1" name="data[BANK_ADDITION_AMOUNTS][]" value="<?php echo $BANK_ADDITION_AMOUNTS_FV; ?>">	
									</div>
								</div>
							</div>
						</div>
						...
						<?php
							if($BANK_ADDITION_HEADS_CNT > 1 && !empty($BANK_ADDITION_HEADS_ARR))
							{
								for($i=1;$i<$BANK_ADDITION_HEADS_CNT;$i++)
								{								
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-md-9 tooltips">										
										<input type="text" placeholder="Example :- ( Deposit in Transit 1, Deposit in Transit 2 )" class="form-control" data-required="1" name="data[BANK_ADDITION_HEADS][]" value="<?php echo $BANK_ADDITION_HEADS_VAL; ?>">
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-md-9 tooltips">
										<input type="text" placeholder="Example :- ( 5000, 6000 )" class="form-control" data-required="1" name="data[BANK_ADDITION_AMOUNTS][]" value="<?php echo $BANK_ADDITION_AMOUNTS_VAL; ?>">	
									</div>
								</div>
							</div>
							<button id="btn_rmv_bnk_aha" class="btn bg-blue-chambray" type="button" style="float: right; margin-right: 1.5%;">Remove</button>
						</div>		
						<?php	
								}
							}
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9 tooltips">
											...
											<input type="text" placeholder="Example :- ( Outstanding Check 1, Outstanding Check 2 )" class="form-control" data-required="1" name="data[BANK_DEDUCTION_HEADS][]" value="<?php echo $BANK_DEDUCTION_HEADS_FV; ?>">
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9 tooltips">
											...
											<input type="text" placeholder="Example :- ( 3000, 4000 )" class="form-control" data-required="1" name="data[BANK_DEDUCTION_AMOUNTS][]" value="<?php echo $BANK_DEDUCTION_AMOUNTS_FV; ?>">	
										</div>
									</div>
								</div>
							</div>
					<?php
						if($BANK_DEDUCTION_HEADS_CNT > 1 && !empty($BANK_DEDUCTION_HEADS_ARR))
						{
							for($i=1;$i<$BANK_DEDUCTION_HEADS_CNT;$i++)
							{								
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-9 tooltips">
									<input type="text" placeholder="Example :- ( Outstanding Check 1, Outstanding Check 2 )" class="form-control" data-required="1" name="data[BANK_DEDUCTION_HEADS][]" value="<?php echo $BANK_DEDUCTION_HEADS_VAL; ?>">
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-9 tooltips">
									<input type="text" placeholder="Example :- ( 3000, 4000 )" class="form-control" data-required="1" name="data[BANK_DEDUCTION_AMOUNTS][]" value="<?php echo $BANK_DEDUCTION_AMOUNTS_VAL; ?>">	
								</div>
							</div>
						</div>
						<button id="btn_rmv_bnk_dha" class="btn bg-blue-chambray" type="button" style="float: right; margin-right: 1.5%;">Remove</button>
					</div>		
					<?php	
							}
						}
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9 tooltips">
											...
											<input type="text" placeholder="Example :- ( Income not recorded on Books, Bank Interest Income )" class="form-control" data-required="1" name="data[BOOK_ADDITION_HEADS][]" value="<?php echo $BOOK_ADDITION_HEADS_FV; ?>">	
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9 tooltips">
											...
											<input type="text" placeholder="Example :- ( 500, 600 )" class="form-control" data-required="1" name="data[BOOK_ADDITION_AMOUNTS][]" value="<?php echo $BOOK_ADDITION_AMOUNTS_FV; ?>">	
										</div>
									</div>
								</div>
							</div>
					<?php
						if($BOOK_ADDITION_HEADS_CNT > 1 && !empty($BOOK_ADDITION_HEADS_ARR))
						{
							for($i=1;$i<$BOOK_ADDITION_HEADS_CNT;$i++)
							{								
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-9 tooltips">
									<input type="text" placeholder="Example :- ( Income not recorded on Books, Bank Interest Income )" class="form-control" data-required="1" name="data[BOOK_ADDITION_HEADS][]" value="<?php echo $BOOK_ADDITION_HEADS_VAL; ?>">	
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-9 tooltips">
									<input type="text" placeholder="Example :- ( 500, 600 )" class="form-control" data-required="1" name="data[BOOK_ADDITION_AMOUNTS][]" value="<?php echo $BOOK_ADDITION_AMOUNTS_VAL; ?>">	
								</div>
							</div>
						</div>
						<button id="btn_rmv_bk_aha" class="btn bg-blue-chambray" type="button" style="float: right; margin-right: 1.5%;">Remove</button>
					</div>		
					<?php	
							}
						}
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9 tooltips">
											...
											<input type="text" placeholder="Example :- ( Expenses not recorded on Books, Bank Account Charges )" class="form-control" data-required="1" name="data[BOOK_DEDUCTION_HEADS][]" value="<?php echo $BOOK_DEDUCTION_HEADS_FV; ?>">		
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9 tooltips">
											...
											<input type="text" placeholder="Example :- ( 300, 400 )" class="form-control" data-required="1" name="data[BOOK_DEDUCTION_AMOUNTS][]" value="<?php echo $BOOK_DEDUCTION_AMOUNTS_FV; ?>">
										</div>
									</div>
								</div>
							</div>
					<?php
						if($BOOK_DEDUCTION_HEADS_CNT > 1 && !empty($BOOK_DEDUCTION_HEADS_ARR))
						{
							for($i=1;$i<$BOOK_DEDUCTION_HEADS_CNT;$i++)
							{								
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-9 tooltips">
									<input type="text" placeholder="Example :- ( Expenses not recorded on Books, Bank Account Charges )" class="form-control" data-required="1" name="data[BOOK_DEDUCTION_HEADS][]" value="<?php echo $BOOK_DEDUCTION_HEADS_VAL; ?>">		
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-9 tooltips">
									<input type="text" placeholder="Example :- ( 300, 400 )" class="form-control" data-required="1" name="data[BOOK_DEDUCTION_AMOUNTS][]" value="<?php echo $BOOK_DEDUCTION_AMOUNTS_VAL; ?>">
								</div>
							</div>
						</div>
						<button id="btn_rmv_bk_dha" class="btn bg-blue-chambray" type="button" style="float: right; margin-right: 1.5%;">Remove</button>
					</div>		
					<?php
							}
						}
							...
							<div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
									...
									<?php
										...
										{
									?>
									<div class="cls_upload_doc_dl"><a href="<?php echo $BANK_STATEMENT_DOCUMENT_DL; ?>" target="_blank"><?php echo $BANK_STATEMENT_DOCUMENT; ?></a></div>
									<?php
										}
									?>
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="data[AccountBankReconciliationStatement][STATUS]" value="1" <?php echo $this->request->data['AccountBankReconciliationStatement']['STATUS'] == 1 ? "checked" : ""; ?> />
                                            Active </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="data[AccountBankReconciliationStatement][STATUS]" value="0" <?php echo $this->request->data['AccountBankReconciliationStatement']['STATUS'] == 0 ? "checked" : ""; ?> />
                                            Inactive </label>
                                    </div>
                                </div>
                            </div>
