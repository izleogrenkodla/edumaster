...
<div class="portlet-title">
    <div class="caption">
        <span aria-hidden="true" class="icon-user"></span> Student Profile
    </div>
    <div class="tools">
        ...
        <div class="row mix-grid">
            <div class="col-md-3 col-sm-4 mix category_1">
                <div class="mix-inner">
                    <?php
                        ...
                        $bcimg = $userData['User']['BIRTH_CERTIFICATION'];
                        $bcpath = SITE_URL . 'files/upload_document/'.$bcimg;

                    ?>
                    <img class="img-responsive" src="<?php echo $bcpath; ?>" alt="">
                    <div class="mix-details">
                        <h4>Birth Certification</h4>
                        <a class="mix-link">
                            <i class="fa fa-link"></i>
                        </a>
                        <a class="mix-preview fancybox-button" href="<?php echo $bcpath; ?>" title="Project Name" data-rel="fancybox-button">
            ...
            <div class="col-md-3 col-sm-4 mix category_3">
                <div class="mix-inner">
                    ...
                    $tcimg = $userData['User']['TRANSFER_CERTIFICATION'];
                    $tcpath = SITE_URL . 'files/upload_document/'.$tcimg;

                    ?>

                    <img class="img-responsive" src="<?php echo $tcpath; ?>" alt="">
                    <div class="mix-details">
                        <h4>Transfer Certification</h4>
                        <a class="mix-link">
                            <i class="fa fa-link"></i>
                        </a>
                        <a class="mix-preview fancybox-button" href="<?php echo $tcpath; ?>" title="Project Name" data-rel="fancybox-button">
                            <i class="fa fa-search"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-3 col-sm-4 mix category_1 category_2">
                <div class="mix-inner">
                    ...
                    $lcimg = $userData['User']['LC'];
                    $lcpath = SITE_URL . 'files/upload_document/'.$lcimg;

                    ?>

                    <img class="img-responsive" src="<?php echo $lcpath; ?>" alt="">
                    <div class="mix-details">
                        <h4>LC</h4>
                        <a class="mix-link">
                            <i class="fa fa-link"></i>
                        </a>
                        <a class="mix-preview fancybox-button" href="<?php echo $lcpath; ?>" title="Project Name" data-rel="fancybox-button">
                            <i class="fa fa-search"></i>
                        </a>
                    </div>
                </div>
