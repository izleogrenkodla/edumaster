...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>  Edit Student
            </div>
            <div class="tools">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                    ...
                                    <?php echo $this->Form->input('FATHER_OCCUPATION', array('type' => 'text',
                                        'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control', 'placeholder' => 'Example :- ( Enginner )')); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom' data-html='true' data-original-title="Middle Name">
									...
									array('type' => 'text','label' => FALSE_VALUE,
...
<?php echo $this->General->uploadfilenotes(); ?>
                            ...
                            <?php
                            if(isset($this->request->data["User"]["BIRTH_CERTIFICATION"]) && $this->request->data["User"]["BIRTH_CERTIFICATION"]!='') {
                                $img = $this->request->data["User"]["BIRTH_CERTIFICATION"];
                                $path = SITE_URL . 'files/upload_document/'.$img;
                                ?>
                                <div style="float:right;width:500px;">
                                    <img src="<?php echo $path ?>"  width="100" />
...
<?php echo $this->General->uploadfilenotes(); ?>
                            ...
                            <?php
                            if(isset($this->request->data["User"]["TRANSFER_CERTIFICATION"]) && $this->request->data["User"]["TRANSFER_CERTIFICATION"]!='') {
                                $img = $this->request->data["User"]["TRANSFER_CERTIFICATION"];
                                $path = SITE_URL . 'files/upload_document/'.$img;
                                ?>
                                <div style="float:right;width:500px;">
                                    <img src="<?php echo $path ?>"  width="100" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Upload LC Photo</label>
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="Upload Profile Photo">
...
<?php echo $this->General->uploadfilenotes(); ?>
                            ...
                            <?php
                            if(isset($this->request->data["User"]["LC"]) && $this->request->data["User"]["LC"]!='') {
                                $img = $this->request->data["User"]["LC"];
                                $path = SITE_URL . 'files/upload_document/'.$img;
                                ?>
                                <div style="float:right;width:500px;">
                                    <img src="<?php echo $path ?>"  width="100" />
