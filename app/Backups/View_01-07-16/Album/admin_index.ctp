            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'Album',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javscript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'Album','action' => 'delete', $album['Album']['ALBUM_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
