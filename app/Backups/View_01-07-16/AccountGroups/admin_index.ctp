...
<?php if(count($data) > 0):
    ...
    <?php foreach($data as $act_grp) { ?>
        <tr>
			...
			<td><?php echo $act_grp['AccountGroup']['SORT_ORDER']; ?></td>
			...
			<?php if($authUser["ROLE_ID"]==ACCOUNT_ID) { ?>
                <a href="<?php echo Router::url(array('controller' => 'AccountGroups',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'AccountGroups','action' => 'delete', $act_grp['AccountGroup']['ACCOUNT_GROUP_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
