            ...
            <td class="text-center">
                <a href="<?php echo Router::url(array('controller' => 'LibraryFineMaster',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'LibraryFineMaster','action' => 'delete', $fines['LibraryFineMaster']['ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
