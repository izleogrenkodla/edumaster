              ...
              <?php if(in_array($this->params['action'], $DEPT_SECTION_ACTION) && in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
                ...
                <ul class="sub-menu">
                  ...
                  <?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryBook', 'action' => 'add', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_add"></span>
                                    <span class="title">Add New</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryBook', 'action' => 'index', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_view_all"></span>
                                    <span class="title">View All</span>
                                </a>
                            </li>
                  ...
                  <?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
						...
						<?php if(in_array($authUser["ROLE_ID"], array(ADMIN_ID,LIBRARY_ID))) { ?>
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryGroup', 'action' => '', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_add"></span>
                                    <span class="title">Add New</span>
                                </a>
                            </li>
                  ...
                  <?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
						...
						<?php if(in_array($authUser["ROLE_ID"], array(ADMIN_ID,LIBRARY_ID))) { ?>
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryPublisher', 'action' => '', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_add"></span>
                                    <span class="title">Add New</span>
                                </a>
                            </li>
                  ...
                  <?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryBookIssue', 'action' => '', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_view_all"></span>
                                    <span class="title">View All</span>
                                </a>
                            </li>
					...
					<li class="<?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
                        <a href="javascript:;">
                            <span class="icn icn_sub icn_sub_ebook"></span>
                            <span class="title">Library Bookbank</span>
                  ...
                  <?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
						...
						<?php if(in_array($authUser["ROLE_ID"], array(ADMIN_ID,LIBRARY_ID))) { ?>
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryBookBank', 'action' => '', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_add"></span>
                                    <span class="title">Add New</span>
                                </a>
                            </li>
                  ...
                  <?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
						...
						<?php if(in_array($authUser["ROLE_ID"], array(ADMIN_ID,LIBRARY_ID))) { ?>
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryBookBankIssue', 'action' => '', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_add"></span>
                                    <span class="title">Add New</span>
                                </a>
                            </li>
					...
					<li class="<?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
                        <a href="javascript:;">
                            <span class="icn icn_sub icn_sub_ebook"></span>
                            <span class="title">News Paper Master</span>
                  ...
                  <?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
						...
						<?php if(in_array($authUser["ROLE_ID"], array(ADMIN_ID,LIBRARY_ID))) { ?>
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryNewsPaper', 'action' => '', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_add"></span>
                                    <span class="title">Add New</span>
                                </a>
                            </li>
					...
					<li class="<?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
                        <a href="javascript:;">
                            <span class="icn icn_sub icn_sub_ebook"></span>
                            <span class="title">News Papers</span>
                  ...
                  <?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
						...
						<?php if(in_array($authUser["ROLE_ID"], array(ADMIN_ID,LIBRARY_ID))) { ?>
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryNewsPaperItem', 'action' => '', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_add"></span>
                                    <span class="title">Add New</span>
                                </a>
                            </li>
					...
					<li class="<?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
                        <a href="javascript:;">
                            <span class="icn icn_sub icn_sub_ebook"></span>
                            <span class="title">Visitor Transaction</span>
                  ...
                  <?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
						...
						<?php if(in_array($authUser["ROLE_ID"], array(ADMIN_ID,LIBRARY_ID))) { ?>
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryVisitor', 'action' => '', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_add"></span>
                                    <span class="title">Add New</span>
                                </a>
                            </li>
					...
					<li class="<?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
                        <a href="javascript:;">
                            <span class="icn icn_sub icn_sub_ebook"></span>
                            <span class="title">Fine Master</span>
                  ...
                  <?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
						...
						<?php if(in_array($authUser["ROLE_ID"], array(ADMIN_ID,LIBRARY_ID))) { ?>
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryFineMaster', 'action' => '', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_add"></span>
                                    <span class="title">Add New</span>
                                </a>
                            </li>
                  ...
                  <?php if(in_array(strtolower($this->params['controller']), $DEPT_SECTION_CONTROLLER)) { echo ''; } ?>">
						...
						<?php if(in_array($authUser["ROLE_ID"], array(ADMIN_ID,LIBRARY_ID))) { ?>
                            <li>
                                <a href="<?php echo Router::url(array('plugin' => false, 'controller' => 'LibraryFine', 'action' => '', 'admin' => true)) ?>">
                                    <span class="icn icn_sub icn_sub_add"></span>
                                    <span class="title">Add New</span>
                                </a>
                            </li>
