...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp; Add Promotion
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('Promotion', array('class' => 'form-horizontal add', 'id' => 'Roles')); ?>
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Promotion Date<span class="required"> * </span></label>
