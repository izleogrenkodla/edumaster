        ...
        <ul class="page-breadcrumb breadcrumb">
            <li class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li>
                        <a href="<?php echo Router::url(array('controller' => 'LibraryVisitor', 'action' => 'index')) ?>">View All DocumentsChecklist</a>
                    </li>
                    <li>
                        <a href="<?php echo Router::url(array('controller' => 'LibraryVisitor', 'action' => 'add')) ?>">Add New Category</a>
                    </li>
                </ul>
            </li>
            <li>
...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>&nbsp; Add Library Visitor
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('LibraryVisitor', array('class' => 'form-horizontal add', 'id' => 'LibraryVisitor')); ?>
                <div class="form-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="col-md-9 tooltips">
                                     <?php echo $this->Form->input('GROUP_ID', array('options' => $LibraryGroup,
                                       'default' => '', 'label' => FALSE_VALUE, 'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control select2me','onchange'=> 'fn_getBooks(this)')); ?>	
                                </div>
                            </div>
                        </div>
                  <div id="books">
                   ...
                   <div class="row">
                       <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips">
                                    <?php echo $this->Form->input('IN_TIME', array('type' => 'text', 'label' => FALSE_VALUE,
						...
						<div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 tooltips">
                                    <?php echo $this->Form->input('OUT_TIME', array('type' => 'text', 'label' => FALSE_VALUE,
                                        'div' => FALSE_VALUE, 'data-required' => '1', 'class' => 'form-control','readonly'=>'readonly')); ?>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function(){
	$('#LibraryVisitorINTIME,#LibraryVisitorOUTTIME').timepicker({ 'step': 15 });
});
</script>
...
<script>
	...
	function fn_getStudents(data){
		...
		var rid = $("#LibraryVisitorROLEID").val() 
