    ...
    <?php foreach($LibraryVisitor as $lb) { ?>
        <tr>
            ...
            <td class="text-center">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'LibraryVisitor','action' => 'delete', $lb['LibraryVisitor']['VISITOR_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
