...
<?php if(count($data) > 0):
    ...
    <?php foreach($data as $vehicle) { ?>
        <tr>
            ...
            <td><?php echo $vehicle['VehicleType']['VEHICLE']; ?></a></td>
            ...
            <td class="text-center">
                ...
                <a href="<?php echo Router::url(array('controller' => 'VehicleType',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'VehicleType','action' => 'delete', $vehicle['VehicleType']['VEHICLE_TYPE_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
