...
<div class="col-md-12">
    ...
    <div class="portlet box blue-madison">
        <div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>  Edit Library
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            'type' => 'file')); ?>
                <div class="form-body">
                    <h3 class="form-section">Library Info</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Select Library Vehicle</label>
                                <div class="col-md-9">
                                    <?php
