...
<div class="col-md-12">
	...
	<div class="portlet box blue-madison">
		<div class="portlet-title">
            <div class="caption">
                <span aria-hidden="true" class="icon-user"></span>  Student Ledger
            </div>
            <div class="tools">
                <a href="javascript:void(0);" class="collapse">
                </a>
			...
			<?php 
                ...
                <div class="form-body">
                    ...
                    <div class="row">
						...
						<div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Academic Fee (Yearly): </label>
                                <div class="col-md-9 tooltips" data-container='body' data-placement='bottom'
                                     data-html='true' data-original-title="First Name">
									 <?php if(isset($academic_fees) && ($academic_fees!='') && ($academic_fees>0) && (is_numeric($academic_fees))) {  ?>
                                    <?php echo number_format($academic_fees,2); ?> (in Rs)
									<?php } ?>
                                </div>
                            </div>
                        </div>
