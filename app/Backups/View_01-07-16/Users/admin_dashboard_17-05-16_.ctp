        ...
        <div class="box_block box_03">
            ...
            <div class="box_content">
                <p>
					...
					foreach($sdata as $s){
					?>
						<p style="border:1px solid #eee; padding:10px 5px;">
							Date:<?php echo $this->General->dbfordate($s['Suggestion']['created']); ?>&nbsp;&nbsp;<br/>
							Name:<?php echo $s['Suggestion']['FIRST_NAME']."".$s['Suggestion']['LAST_NAME']; ?>&nbsp;&nbsp;<br/>Message:<?php echo $s['Suggestion']['SUGGESTION_MESSAGE'];?>&nbsp;&nbsp;<br/>
						</p>
					<?php }?>
					<a href="<?php echo Router::url(array('controller' => 'Suggestions', 'action' => '')) ?>">View All</a>
                </p>
            </div>
        ...
        <div class="box_block box_04">
            ...
            <div class="box_content">
                <p>
					...
					?>
						<p style="border:1px solid #eee; padding:10px 5px;">
							Date:<?php echo $n['News']['START_DATE'];?>&nbsp;&nbsp;<br/>
							News Title:<?php echo $n['News']['NEWS_TITLE'] ?>&nbsp;&nbsp;<br/>
						</p>
					<?php }?>
					<a href="<?php echo Router::url(array('controller' => 'News', 'action' => '')) ?>">View All</a>
                </p>
            </div>
        ...
        <div class="box_block box_10">
            ...
            <div class="box_content">
                <p>
					...
					<?php }?>
					<a href="<?php echo Router::url(array('controller' => 'Events', 'action' => '')) ?>">View All</a>
                </p>
            </div>
