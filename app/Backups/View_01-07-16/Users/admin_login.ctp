...
<?php //echo $this->Session->flash('auth'); ?>
    ...
    <div class="form-group">
        ...
        <div class="input-icon">
            ...
            <?php echo $this->Form->input('USERNAME', array('type' => 'text', 'label' => FALSE_VALUE,
    ...
    <div class="form-group">
        ...
        <div class="input-icon">
            <?php
            echo $this->Form->input('ROLE_ID', array('options' => $roles, 'default' => '', 'class' => 'form-control select2me', 
...
<!--    <div class="login-options">
    ...
    <div class="forget-password">
        <h4><a href="<?php echo Router::url(array
                ('controller' => 'Users', 'action' => 'forgot_password')) ?>">Click Here to Reset Password</a></h4>
<!--        <p>
            no worries, click 
                here </a>
