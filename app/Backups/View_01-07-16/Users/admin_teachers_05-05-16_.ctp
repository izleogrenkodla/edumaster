...
<div class="portlet-title">
    <div class="caption">
        <span aria-hidden="true" class="icon-users"></span>View All Teacher
    </div>
</div>
        ...
        <tr>
            ...
            <a href="<?php echo Router::url(array('controller' => 'Users',
               ...
               <?php if($authUser["ROLE_ID"]==ADMIN_ID) { ?>
                ...
                <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'Users','action' => 'delete_teacher', $user['User']['ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
