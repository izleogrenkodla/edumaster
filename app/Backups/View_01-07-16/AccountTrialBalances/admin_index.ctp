...
<?php if(count($data) > 0):
    ...
    <?php foreach($data as $act_grp) { ?>
        <tr>
			...
			?>
			<td><?php echo $act_grp['AccountTrialBalance']['DATE']; ?></td>
			...
			<td><?php echo $act_grp['AccountTrialBalance']['SORT_ORDER']; ?></td>
            ...
            <td class="text-center">
                ...
                ))?>" class="tooltips btn" data-container="body" data-placement="top" data-html="true" title="View Account Trial Balance"
			...
			<?php if($authUser["ROLE_ID"]==ACCOUNT_ID) { ?>
                <a href="<?php echo Router::url(array('controller' => 'AccountTrialBalances',
                   ...
                   data-original-title="Edit">
                    ...
                    <a href="javascript::void(0);" onclick="remove_record('<?php echo Router::url(array('controller' => 'AccountTrialBalances','action' => 'delete', $act_grp['AccountTrialBalance']['ACCOUNT_TRIAL_BAL_ID']))?>')" class="tooltips btn" data-container="body" data-placement="top" data-html="true"
