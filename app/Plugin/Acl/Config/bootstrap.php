 ...
 */
Configure :: write('acl.aro.role.display_field', 'role_name');
 ...
 */
Configure :: write('acl.role.access_plugin_role_ids', array(1, 12));
 ...
 */
Configure :: write('acl.user.display_name', "CONCAT(User.user_id)");
 ...
 */
Configure :: write('acl.gui.roles_prolesions.ajax', true);
