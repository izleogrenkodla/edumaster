...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body class="background-fixed" style="background:url(\image/gdg.png); background-attachment:fixed;  background-position:fixed; background-size:cover;">
      
	    <script  src="js/style-switcher/jquery-1.9.1.js"></script>  

        <script  src="js/style-switcher/styleSwitcher.js"></script>

		 <link rel="stylesheet" href="js/style-switcher/styleSwitcher.css"/>

	   <section id="style-switcher" class="" style="border:1px solid #eee;">
            <section id="styles-container">
                    <h1 style="padding:0 0 0 10px; color:#fff;"  class="" data-toggle="modal" data-target="#exampleModal">Admission Inquiry</h1>
               

            </section>
            <a href="#" id="styles-button" style="color:#fff; padding-left:4px;"><div id="switcher-logo" class="glyphicon glyphicon-th"></div></a>
        </section>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	 ...
	 <div class="bond-menu-three" style="background:#fff;">
       ...
       <header style=" //height: 0;" class="header fixed clearfix col-xs-12">
        ...
        <div class="col-sm-3 col-xs-12" align="left">
			 <a href="http://<?php echo $SERVER_NAME_GLOB; ?>/<?php echo $SITE_FOLDER_NAME_GLOB; ?>/user_list.php"> <img src="http://<?php echo $SERVER_NAME_GLOB; ?>/<?php echo $SITE_FOLDER_NAME_GLOB; ?>/app/webroot/files/upload_document/<?php echo $SCHOOL_LOGO_IMAGE; ?>" width="124" height="124" />
			</a></div>
				<div class="name-shools" style="float:none !important;">
				...
				<h4 style="display:none;"><?php echo $SCHOOL_TAGLINE; ?></h4>
				<a href="Apk/SchoolERP.apk" style="width:250px; margin-top:15px; height:70px; right:10px; float:right;"><img src="image/DOWNLOAD.gif" width="100%" height="100%"  alt=""/></a>
                  ...
                  <div id="menu1" class="tab-pane fade in active">
                    ...
                    <div class="col-xs-12 col-sm-5">
                      <div class="img-box-main">
                        <img src="http://<?php echo $SERVER_NAME_GLOB; ?>/<?php echo $SITE_FOLDER_NAME_GLOB; ?>/app/webroot/files/upload_document/<?php echo $SCHOOL_LOGO_IMAGE; ?>" width="100%" height="100%" />
                      </div>
                    </div>
                    <div class="text-box-home col-xs-12 col-sm-7">
					<p class="text-p">The New School aims at nurturing individuals with paramount values and multivalent competencies.</p>
					  <p class="text-p"> This is accomplished by focusing not only towards academic excellence but also all round development of the child, his character and personality, aesthetic refinements, effective skills and the art of living.</p>
                      <p class="text-p">&ldquo;Today&rsquo;s education is tomorrow&rsquo;s future of the child &rdquo;</strong- aiming this concept, ><br />Our professionals&rsquo; team tag along the progress of each child in every bit of facet to the learning. On the basis of skills and capabilities of the child; we bring in the varied methodologies for overcoming the lapse of concept clarity followed by disinterest towards the subject. Our special educators and counsellors always be ready to this context. We provide remedial intervention on one to one basis or in small group sessions.<br />In regard to emphasise the universal and qualitative education amongst students we always try to facilitate the child with the best in all areas.</p>	
                    </div>
